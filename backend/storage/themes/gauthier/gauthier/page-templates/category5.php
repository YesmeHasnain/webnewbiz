<div <?php body_class(); ?>>
    <div class="category1-topheader">
        <div class="category1-topinside">
            ...
            <div class="category1-totalpost">
                ...
                <?php echo display_current_category_post_count();?> </div>			
    ...
    if ( isset( $category ) && ! is_wp_error( $category ) ) {
        ...
        $attachment_id = get_term_meta( $category_id, 'catfit_id', true );
        if ( $attachment_id ) {
            echo wp_get_attachment_image( $attachment_id, 'gauthier-large' );
        } else {
...
<div class="category1-wrapperinside">
    <div id="primary" <?php body_class('site-content'); ?>> <a href="<?php echo esc_html ( get_term_meta( $category_id, 'adv_cattoplink', 1 ), 'true' ); ?>" target="_blank">
