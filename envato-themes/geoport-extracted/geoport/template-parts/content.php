          ...
          <div class="bpost-meta mb-20">
            <ul>
              ...
              <?php }
                ...
                <li><span><i class="fal fa-comments"></i><?php comments_popup_link( '<span class="leave-reply">' . esc_html__( 'No comment', 'geoport' ) . '</span>', esc_html__( 'One comment', 'geoport' ), esc_html__( '% comments', 'geoport' ) ); ?></span></li>
