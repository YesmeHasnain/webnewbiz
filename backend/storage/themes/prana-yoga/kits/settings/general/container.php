...
class Container extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Global Container', 'prana-yoga' );
	}
	...
	protected function register_toggle_controls() {
		...
		$this->add_control(
			'container_notice',
			array(
				'raw' => esc_html__( 'Global settings that are used as defaults for the container and content in Header Top, Header Middle, Header Bottom, Main, Heading, Breadcrumbs (new row type), Footer Widgets, Footer.', 'prana-yoga' ),
		...
		$this->add_responsive_control(
			'container_width',
			array(
				'label' => esc_html__( 'Container Max Width', 'prana-yoga' ),
		...
		$this->add_responsive_control(
			'content_width',
			array(
				'label' => esc_html__( 'Content Max Width', 'prana-yoga' ),
				'type' => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'min' => 300,
		...
		$this->add_responsive_control(
			'content_padding',
			array(
				'label' => esc_html__( 'Content Horizontal Padding', 'prana-yoga' ),
