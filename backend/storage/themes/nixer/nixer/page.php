...
?>
<?php
function nixer_get_post_views($postID) {
								...
								<div class="tp-postbox-details-mate d-flex align-items-center mb-50 p-relative">
									<div class="tp-postbox-details-author d-flex align-items-center">
										...
										<div class="tp-postbox-details-author-content">
											...
											<?php } ?>
											<h4 class="tp-postbox-details-author-title text-cap"><?php echo esc_html(get_the_author_meta('display_name', $author_id)); ?></h4>
										</div>
									</div>
										...
										<h4 class="tp-postbox-details-author-title">
											<a href="#singlecomment">
												<?php if (!empty($nixer_redux_demo['post-meta-2'])) { ?>
													<?php echo esc_attr($nixer_redux_demo['post-meta-2']);?>
												<?php } else { ?>
									...
									<?php if (!empty($nixer_redux_demo['post-show-view'])): ?>
										<div class="tp-postbox-details-author-content">
											<?php if (!empty($nixer_redux_demo['post-meta-3'])) { ?>
												<span><?php echo esc_html($nixer_redux_demo['post-meta-3']);?></span>
											<?php } else { ?>
												<span><?php echo html_entity_decode( 'View' , ENT_COMPAT , 'nixer' ) ?></span>
											<?php } ?>
											<h4 class="tp-postbox-details-author-title"><?php echo esc_html(nixer_get_post_views(get_the_ID())); ?></h4>
										</div>
									<?php endif ?>
													...
													<div class="tp-postbox-details-social d-flex align-items-center">
														<h4 class="tp-postbox-details-social-title">
															<?php if (!empty($nixer_redux_demo['share-label'])) { ?>
																<?php echo esc_attr($nixer_redux_demo['share-label']);?>
															<?php } else { ?>
