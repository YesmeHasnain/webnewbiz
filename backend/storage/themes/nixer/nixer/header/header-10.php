...
<body id="body" <?php body_class('tp-magic-cursor'); ?>>
	...
	<?php get_template_part( 'header/header-templates/header', 'loop-modal' );?>
	<?php if (!empty($nixer_redux_demo['h10-right-item']) && !empty($nixer_redux_demo['h10-mini-cart-switch'])): ?>
		<?php get_template_part( 'header/header-templates/header', 'minicart' ); ?>
	<?php endif ?>
	<?php get_template_part( 'header/header-templates/header', 'canvas' ); ?>

	<header class="tp-header-inner-ptb bg-shadow tp-header-transparent">
		<div id="header-sticky" class="tp-header-main-sticky p-relative">
			<div class="container container-1760">
				<div class="d-flex justify-content-between align-items-center">
					<div class="tp-header-logo">
						<a href="<?php echo esc_url(home_url('/')); ?>">
							<?php if (!empty($nixer_redux_demo['h10-logo-white']['url'])) { ?>
								<img class="white d-none d-lg-none d-xl-none" data-width="120" src="<?php echo esc_url($nixer_redux_demo['h10-logo-white']['url']); ?>" alt="<?php bloginfo( 'name' ); ?>">
							<?php } else { ?>
								<img class="white d-none d-lg-none d-xl-none" data-width="120" src="<?php echo esc_url(get_template_directory_uri());?>/assets/img/logo/logo.png" alt="<?php bloginfo( 'name' ); ?>">
							<?php } ?>
							<?php if (!empty($nixer_redux_demo['h10-logo-black']['url'])) { ?>
								<img class="black d-block d-lg-block d-xl-block" data-width="120" src="<?php echo esc_url($nixer_redux_demo['h10-logo-black']['url']); ?>" alt="<?php bloginfo( 'name' ); ?>">
							<?php } else { ?>
								<img class="black d-block d-lg-block d-xl-block" data-width="120" src="<?php echo esc_url(get_template_directory_uri());?>/assets/img/logo/logo-black.png" alt="<?php bloginfo( 'name' ); ?>">
							<?php } ?>
						</a>
					</div>
					<div class="tp-header-inner-box d-flex align-items-center justify-content-between">
						<div class="tp-header-inner-menu d-none d-xl-block">
						...
						<?php if (!empty($nixer_redux_demo['h10-right-item'])) { ?>
							<div class="tp-header-inner-right d-flex align-items-center">
								<?php if (!empty($nixer_redux_demo['h10-mini-cart-switch'])): ?>
								...
								<?php endif ?>
								<?php if (!empty($nixer_redux_demo['h10-canvas-switch'])) { ?>
						...
						<?php } else { ?>
							<div class="tp-header-inner-right d-flex align-items-center d-block d-xl-none">
								<div class="tp-header-hamburger offcanvas-open-btn">
									<button class="tp-hamburger-btn">
										<span></span>
										<span></span>
