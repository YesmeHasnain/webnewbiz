<?php
namespace PranaYogaSpace\Kits;

use PranaYogaSpace\Kits\Classes;
use PranaYogaSpace\Kits\Controls\Controls_Manager;
...
class Module extends ElementorBaseModule {
	...
	public function enqueue_scripts() {
		if ( ! class_exists( 'Cmsmasters_Elementor_Addon' ) ) {
			...
			wp_enqueue_script(
				'prana-yoga-elementor-kits-controls',
