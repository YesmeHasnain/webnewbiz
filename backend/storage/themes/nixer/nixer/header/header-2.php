...
<body id="body" <?php body_class('tp-magic-cursor'); ?>>
	...
	<div class="tp-offcanvas-2-area p-relative">
		...
		<div class="tp-offcanvas-2-wrapper">
				...
				<div class="tp-offcanvas-2-left-wrap d-flex justify-content-between align-items-center">
					<div class="tp-offcanvas__logo">
						<a class="logo-1" href="<?php echo esc_url(home_url('/')); ?>">
							<?php if (!empty($nixer_redux_demo['h2-logo-menu']['url'])) { ?>
								<img data-width="120" src="<?php echo esc_url($nixer_redux_demo['h2-logo-menu']['url']); ?>" alt="<?php bloginfo( 'name' ); ?>">
							<?php } else { ?>
					...
					<div class="tp-offcanvas-2-close d-md-none text-end">
						<button class="tp-offcanvas-2-close-btn tp-offcanvas-2-close-btn">
							<?php if (!empty($nixer_redux_demo['h2-text-close'])): ?>
								<span class="text">
									<span><?php echo esc_html($nixer_redux_demo['h2-text-close']); ?></span>
								</span>
							<?php endif ?>
			...
			<div class="tp-offcanvas-2-right right-box d-none d-md-block p-relative">
				...
				<?php if (!empty($nixer_redux_demo['h2-text-canvas-right'])): ?>
					<div class="tp-offcanvas-2-right-text">
						<h3><?php echo esc_html($nixer_redux_demo['h2-text-canvas-right']); ?></h3>
					</div>
				<?php endif ?>
				<div class="tp-offcanvas-2-right-inner d-flex align-items-end justify-content-end h-100">
					<div class="tp-offcanvas-2-right-info">
						<div class="tp-offcanvas-2-thumb text-end">
							<?php if (!empty($nixer_redux_demo['h2-img-right-menu']['url'])): ?>
								<img src="<?php echo esc_url($nixer_redux_demo['h2-img-right-menu']['url']); ?>" alt="<?php bloginfo( 'name' ); ?>">
							<?php endif ?>
						</div>
					</div>
				</div>
	...
	<header id="header-sticky" class="tp-header-2-ptb tp-header-transparent">
		<div class="tp-header-main-sticky p-relative tp-header-height">
			<div class="container container-1800">
				<div class="d-flex justify-content-between align-items-center">
					<div class="tp-header-logo">
						<a href="<?php echo esc_url(home_url('/')); ?>">
							<?php if (!empty($nixer_redux_demo['h2-logo']['url'])) { ?>
								<img class="black" data-width="120" src="<?php echo esc_url($nixer_redux_demo['h2-logo']['url']); ?>" alt="<?php bloginfo( 'name' ); ?>">
							<?php } else { ?>
								<img class="black" data-width="120" src="<?php echo esc_url(get_template_directory_uri());?>/assets/img/logo/logo-black.png" alt="<?php bloginfo( 'name' ); ?>">
							<?php } ?>
						</a>
					</div>
					<div class="tp-header-2-hamburger">
					...
					<div class="tp-header-box d-none d-md-flex align-items-center justify-content-between">
						...
						<?php if (!empty($nixer_redux_demo['h2-button-switch'])): ?>
							<div class="tp-header-main-right d-flex align-items-center">
								<div class="tp-header-2-right-btn d-none d-md-block">
									<?php if (!empty($nixer_redux_demo['h2-link-button']) && !empty($nixer_redux_demo['h2-text-button'])): ?>
										<a class="tp-btn-animation" href="<?php echo esc_attr($nixer_redux_demo['h2-link-button']); ?>">
											<?php for ($i = 0; $i < 6; ++$i) { ?>
												<span><?php echo esc_html($nixer_redux_demo['h2-text-button']); ?></span>
											<?php } ?>
										</a>
									<?php endif ?>
								</div>
