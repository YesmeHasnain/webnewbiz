...
<?php 
  ...
  if($post_meta_data == ''){
    if(!empty($startli_option['page_banner_main']['url'])):
      $post_meta_data = $startli_option['page_banner_main']['url'];
    
    else: {
      $post_meta_data2 = !empty($startli_option['breadcrumb_bg_color'])? $startli_option['breadcrumb_bg_color'] : '';
    }
    endif;
  }  
