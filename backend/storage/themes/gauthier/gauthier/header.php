    ...
    <header id="masthead" class="site-header">
        <div class="header-top4">
            ...
            <div class="topheader4-right">
				...
				if ( isset($redux_gauthier['jp_socmedlink1']) ){ ?>
                ...
                <?php endif; ?>
               <?php global $redux_gauthier;
				if(isset($redux_gauthier['jp_socmedlink2']) && $redux_gauthier['jp_socmedlink2']): ?>
                ...
                <?php endif; ?>
                <?php global $redux_gauthier;
				if(isset($redux_gauthier['jp_socmedlink3']) && $redux_gauthier['jp_socmedlink3']): ?>
                ...
                <?php endif; ?>
                <?php global $redux_gauthier;
				if(isset($redux_gauthier['jp_socmedlink4']) && $redux_gauthier['jp_socmedlink4']): ?>
                ...
                <?php endif; ?>
                <?php global $redux_gauthier;
				if(isset($redux_gauthier['jp_socmedlink5']) && $redux_gauthier['jp_socmedlink5']): ?>
                ...
                <?php endif; ?>
                <?php global $redux_gauthier;
				if(isset($redux_gauthier['jp_socmedlink6']) && $redux_gauthier['jp_socmedlink6']): ?>
        ...
        <div class="nav-mainwrapper">
            <div class="header-style1"> 
                ...
                <div class="gauthierlogo">			
                   <?php global $redux_gauthier;
					if ( isset($redux_gauthier['opt_header_logo']['url']) && !empty($redux_gauthier['opt_header_logo']['url']) ){ ?>
                    ...
                    <?php }else { ?>
                    <h1><a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php esc_attr_e("Gauthier", "gauthier"); ?></a><h1>
                    <?php } ?>
                </div>
