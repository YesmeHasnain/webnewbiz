...
class Nav extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Posts Navigation', 'prana-yoga' );
	}
	...
	protected function register_toggle_controls() {
		...
		$this->add_control(
			'nav_text_above_prev',
			array(
				'label' => esc_html__( 'Text Above Previous Post Title', 'prana-yoga' ),
				'label_block' => true,
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'prana-yoga' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'Previous', 'prana-yoga' ),
			)
		);
		...
		$this->add_control(
			'nav_text_above_next',
			array(
				'label' => esc_html__( 'Text Above Next Post Title', 'prana-yoga' ),
				'label_block' => true,
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'prana-yoga' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'Next', 'prana-yoga' ),
			)
		);
