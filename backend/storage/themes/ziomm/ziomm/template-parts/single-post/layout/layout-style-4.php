		...
		if ( has_post_thumbnail() ) {
			...
			switch( $format ) {
				...
				case 'video':
					...
					get_template_part( 'template-parts/single-post/media/media-style-3', 'video' );

				break;

				case 'gallery':

					get_template_part( 'template-parts/single-post/media/media-style-3', 'gallery' );

				break;

				default:

					get_template_part( 'template-parts/single-post/media/media-style-3', 'standard' );
