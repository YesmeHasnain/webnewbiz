<?php
namespace PranaYogaSpace\Kits\Settings\Heading;
...
class Breadcrumbs extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Breadcrumbs', 'prana-yoga' );
	}
	...
	protected function register_toggle_controls() {
		...
		$this->add_control(
			...
			array_merge_recursive(
				...
				array(
					'label' => esc_html__( 'Colors', 'prana-yoga' ),
		...
		$this->add_control(
			...
			array_merge_recursive(
				$default_visibility_args,
				array(
					'label' => esc_html__( 'Link', 'prana-yoga' ),
					'type' => Controls_Manager::COLOR,
					'dynamic' => array(),
					'selectors' => array(
		...
		$this->add_control(
			...
			array_merge_recursive(
				$default_visibility_args,
				array(
					'label' => esc_html__( 'Link Hover', 'prana-yoga' ),
					'type' => Controls_Manager::COLOR,
					'dynamic' => array(),
					'selectors' => array(
		...
		$this->add_control(
			...
			array_merge_recursive(
				$default_visibility_args,
				array(
					'label' => esc_html__( 'Divider', 'prana-yoga' ),
					'type' => Controls_Manager::COLOR,
					'dynamic' => array(),
					'selectors' => array(
		...
		$this->add_control(
			...
			array_merge_recursive(
				...
				array(
					...
					'options' => array(
						'in_title' => array(
							'title' => esc_html__( 'In Title', 'prana-yoga' ),
						),
						'new_row' => array(
							'title' => esc_html__( 'New Row', 'prana-yoga' ),
						),
					),
					'default' => $this->get_default_setting(
		...
		$this->add_control(
			...
			array_merge_recursive(
				$default_visibility_args,
				array(
					'label' => esc_html__( 'Position of title', 'prana-yoga' ),
					'label_block' => false,
					'description' => esc_html__( 'This setting will be applied after save and reload.', 'prana-yoga' ),
					'type' => CmsmastersControls::CHOOSE_TEXT,
					'options' => array(
						'above_title' => array(
							'title' => esc_html__( 'Above', 'prana-yoga' ),
						),
						'below_title' => array(
							'title' => esc_html__( 'Below', 'prana-yoga' ),
						),
					),
					'default' => $this->get_default_setting(
		...
		$this->add_responsive_control(
			...
			array_merge_recursive(
				...
				array(
					...
					'description' => esc_html__( 'Gap between breadcrumbs and title', 'prana-yoga' ),
		...
		$this->add_control(
			...
			array_merge_recursive(
				$default_visibility_args,
				array(
					'label' => esc_html__( 'Visibility on Devices', 'prana-yoga' ),
					'label_block' => false,
					'description' => esc_html__( 'This setting will be applied after save and reload.', 'prana-yoga' ),
					'type' => Controls_Manager::SELECT,
					'options' => array(
						'show' => esc_html__( 'Show', 'prana-yoga' ),
						'hide_mobile' => esc_html__( 'Hide on mobile', 'prana-yoga' ),
						'hide_tablet' => esc_html__( 'Hide on tablet and mobile', 'prana-yoga' ),
					),
					'default' => $this->get_default_setting(
