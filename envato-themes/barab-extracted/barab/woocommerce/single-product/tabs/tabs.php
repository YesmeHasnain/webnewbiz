...
if ( ! empty( $tabs ) ) : ?>
        ...
        <ul class="nav product-tab-style1" id="productTab" role="tablist">
            ...
            ?>    
				<li class="nav-item" role="presentation"><a class="nav-link th-btn btn-mask style4 <?php echo esc_attr( $tabactivecls );?>" data-bs-toggle="tab" href="#<?php echo esc_attr( $key );?>" role="tab" aria-controls="<?php echo esc_attr( $key );?>" id="tab-<?php echo esc_attr( $key ); ?> area-selected="<?php echo esc_attr( $area );?>""><?php echo apply_filters( 'woocommerce_product_' . $key . '_tab_title', esc_html( $tab['title'] ), $key ); ?></a></li>
            <?php
                $tabcount++;
                endforeach;
            ?>
