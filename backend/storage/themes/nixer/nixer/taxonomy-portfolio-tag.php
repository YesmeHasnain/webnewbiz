			...
			<div class="col-lg-12">
				<div class="tp-blog-heading portfolio p-relative pb-100 mb-155">
					<span class="tp-breadcrumb-subtitle">
						<?php if(isset($nixer_redux_demo['porttag-title']) && $nixer_redux_demo['porttag-title']!=''){?>
							<?php echo wp_specialchars_decode(esc_attr($nixer_redux_demo['porttag-title']));?>
						<?php }else{?>
							<?php echo esc_html__( 'Portfolio Tag', 'nixer' );
						}?>
					</span>
