...
<body id="body" <?php body_class(); ?>>
	...
	<div class="tp-offcanvas-2-area nixer-dark p-relative">
		...
		<div class="tp-offcanvas-2-wrapper">
				...
				<div class="tp-offcanvas-2-left-wrap d-flex justify-content-between align-items-center">
					<div class="tp-offcanvas__logo">
						<a class="logo-1" href="<?php echo esc_url(home_url('/')); ?>">
							<?php if (!empty($nixer_redux_demo['h7-logo-menu']['url'])) { ?>
								<img data-width="120" src="<?php echo esc_url($nixer_redux_demo['h7-logo-menu']['url']); ?>" alt="<?php bloginfo( 'name' ); ?>">
							<?php } else { ?>
					...
					<div class="tp-offcanvas-2-close d-md-none text-end">
						<button class="tp-offcanvas-2-close-btn tp-offcanvas-2-close-btn">
							<?php if (!empty($nixer_redux_demo['h7-text-close'])): ?>
								<span class="text">
									<span><?php echo esc_html($nixer_redux_demo['h7-text-close']); ?></span>
								</span>
							<?php endif ?>
			...
			<div class="tp-offcanvas-2-right right-box d-none d-md-block p-relative">
				...
				<?php if (!empty($nixer_redux_demo['h7-text-canvas-right'])): ?>
					<div class="tp-offcanvas-2-right-text">
						<h3><?php echo esc_html($nixer_redux_demo['h7-text-canvas-right']); ?></h3>
					</div>
				<?php endif ?>
				<div class="tp-offcanvas-2-right-inner d-flex align-items-end justify-content-end h-100">
					<div class="tp-offcanvas-2-right-info">
						<div class="tp-offcanvas-2-thumb text-end">
							<?php if (!empty($nixer_redux_demo['h7-img-right-menu']['url'])): ?>
								<img src="<?php echo esc_url($nixer_redux_demo['h7-img-right-menu']['url']); ?>" alt="<?php bloginfo( 'name' ); ?>">
							<?php endif ?>
						</div>
					</div>
				</div>
	...
	<header id="header-sticky" class="tp-header-7-ptb tp-header-transparent">
		<div class="tp-header-main-sticky p-relative">
			<div class="container container-1800">
				<div class="d-flex justify-content-between align-items-center">
					<div class="tp-header-7-logo">
						<a href="<?php echo esc_url(home_url('/')); ?>">
							<?php if (!empty($nixer_redux_demo['h7-logo']['url'])) { ?>
								<img data-width="120" src="<?php echo esc_url($nixer_redux_demo['h7-logo']['url']); ?>" alt="<?php bloginfo( 'name' ); ?>">
							<?php } else { ?>
								<img data-width="120" src="<?php echo esc_url(get_template_directory_uri());?>/assets/img/logo/logo.png" alt="<?php bloginfo( 'name' ); ?>">
							<?php } ?>
						</a>
					</div>
					<div class="tp-header-7-box">
						<div class="tp-header-7-menu">
						...
						<div class="tp-header-7-hamburger-box offcanvas-open-btn d-flex align-items-center">
							<?php if (!empty($nixer_redux_demo['h7-text-button-menu'])): ?>
								<span class="tp-header-7-hamburger-text"><?php echo esc_html($nixer_redux_demo['h7-text-button-menu']); ?></span>
							<?php endif ?>
