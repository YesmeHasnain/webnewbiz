...
if( !function_exists('saasten_post_tags')){
	
	function saasten_post_tags() {
...
function saasten_get_post_view() {
...
function saasten_set_post_view() {
...
// ----------------------------------------------------------------------------------------
function saasten_video_embed($url){
...
if(!function_exists('saasten_theme_post_navigation')) {
  function saasten_theme_post_navigation() { 
        ...
        <div class="theme_blog_Nav post_nav_Left <?php echo (empty($prev_thumbnail)) ? 'no-thumb':''; ?>">
          ...
          <div class="theme_blog_nav_Inner">
            <div class="theme_blog_nav_Label">
				...
				<?php $blog_prev_title = saasten_get_option('blog_prev_title');  ?>
      ...
      <div class="<?php echo esc_attr($col_class); ?>">
        ...
        <div class="theme_blog_Nav post_nav_Right <?php echo (empty($next_post_thumbnail)) ? 'no-thumb':''; ?>">
          ...
          <div class="theme_blog_Inner">
			...
			<?php $blog_next_title = saasten_get_option('blog_next_title');  ?>
