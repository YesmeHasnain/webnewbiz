...
class Table extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Table', 'prana-yoga' );
	}
	...
	protected function register_toggle_controls() {
		$this->add_control(
			'notice',
			array(
				'raw' => esc_html__( 'Used in: default table, Gutenberg editor.', 'prana-yoga' ),
		...
		$parts = array(
			'tbody' => '',
			'thead' => esc_html__( 'Header', 'prana-yoga' ),
			'tfoot' => esc_html__( 'Footer', 'prana-yoga' ),
		);
