<?php
namespace PranaYogaSpace\Kits\Settings\HeaderMid;
...
class Header_Mid extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Header Middle', 'prana-yoga' );
	}
	...
	protected function register_toggle_controls() {
		$this->add_control(
			'notice',
			array(
				'raw' => esc_html__( "If you use a 'Header' template, then the settings will not be applied, if you set the template to sitewide, then these settings will be hidden.", 'prana-yoga' ),
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					'wide' => array(
						'title' => esc_html__( 'Wide', 'prana-yoga' ),
					),
					'centered' => array(
		...
		$this->add_control(
			'height',
			array(
				'label' => esc_html__( 'Height', 'prana-yoga' ),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Content Element', 'prana-yoga' ),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'description' => esc_html__( 'Gap between content and additional content', 'prana-yoga' ),
				'type' => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'min' => -10,
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Additional Content Elements Order', 'prana-yoga' ),
				'type' => Controls_Manager::HEADING,
				'condition' => array(
					$this->get_control_id_parameter( '', 'type' ) => 'wide',
				),
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					...
					'button' => esc_html__( 'Button', 'prana-yoga' ),
					'search_button' => esc_html__( 'Search Button', 'prana-yoga' ),
				),
				'multiple' => true,
				'default' => $this->get_default_setting(
		...
		$this->add_responsive_control(
			...
			array(
				'label' => esc_html__( 'Gap Between', 'prana-yoga' ),
				'description' => esc_html__( 'Gap between additional content items', 'prana-yoga' ),
				'type' => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'min' => -10,
		...
		$this->add_responsive_control(
			'z_index',
			array(
				'label' => esc_html__( 'Z-Index', 'prana-yoga' ),
