			...
			<?php if (function_exists('dynamic_sidebar')) {
                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class('clearfix blog-post'); ?>>
                    ...
                    <div class="blog-slider ani-slider slider" data-slick='{"autoplaySpeed":
                            <?php if (class_exists('Kirki') && get_theme_mod('mancink_blog_slider_delay') != '') {
                                echo esc_attr(get_theme_mod('mancink_blog_slider_delay'));
                            } else {
                                echo '8000';
                            } ?> }'>
                    ...
                    <div class="audio">
                        <?php $mancink_audio = get_post_meta(get_the_ID(), 'post_audio_setting', true);
                                echo wp_kses($mancink_audio, array(
                                    'iframe' => array(
                                        'src' => array(),
                                        'width' => array(),
                                        'height' => array(),
                ...
                <div class="img-pagination">
                    ...
                    <div class="pagi-nav-box next">
                        ...
                        <?php next_post_link('%link', "<div class='imgpagi-box'><h4 class='pagi-title'>%title</h4> <p>$mancink_next</p></div> <div class='img-pagi'><i class='fa 
