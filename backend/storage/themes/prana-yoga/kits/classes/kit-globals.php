<?php
namespace PranaYogaSpace\Kits\Classes;

use PranaYogaSpace\Kits\Documents\Kit;
...
class Kit_Globals {
	...
	public static function get_global_colors_defaults() {
		return array(
			array(
				'_id' => 'primary',
				'title' => esc_html__( 'Primary', 'prana-yoga' ),
				'color' => Theme_Config::PRIMARY_COLOR_DEFAULT,
			),
			array(
				'_id' => 'secondary',
				'title' => esc_html__( 'Secondary', 'prana-yoga' ),
				'color' => Theme_Config::SECONDARY_COLOR_DEFAULT,
			),
			array(
				'_id' => 'text',
				'title' => esc_html__( 'Text', 'prana-yoga' ),
				'color' => Theme_Config::TEXT_COLOR_DEFAULT,
			),
			array(
				'_id' => 'accent',
				'title' => esc_html__( 'Accent', 'prana-yoga' ),
				'color' => Theme_Config::ACCENT_COLOR_DEFAULT,
			),
			array(
				'_id' => 'tertiary',
				'title' => esc_html__( 'Alternate Accent', 'prana-yoga' ),
				'color' => Theme_Config::TERTIARY_COLOR_DEFAULT,
			),
			array(
				'_id' => 'background',
				'title' => esc_html__( 'Background', 'prana-yoga' ),
				'color' => Theme_Config::BACKGROUND_COLOR_DEFAULT,
			),
			array(
				'_id' => 'alternate',
				'title' => esc_html__( 'Alternate Background', 'prana-yoga' ),
				'color' => Theme_Config::ALTERNATE_COLOR_DEFAULT,
			),
			array(
				'_id' => 'border',
				'title' => esc_html__( 'Border', 'prana-yoga' ),
	...
	public static function get_global_typography_defaults() {
		...
		return array(
			...
			array(
				'_id' => 'meta',
				'title' => esc_html__( 'Meta', 'prana-yoga' ),
				$typography_key => 'custom',
			...
			array(
				'_id' => 'taxonomy',
				'title' => esc_html__( 'Alternate Meta', 'prana-yoga' ),
				$typography_key => 'custom',
			...
			array(
				'_id' => 'small',
				'title' => esc_html__( 'Small', 'prana-yoga' ),
				$typography_key => 'custom',
			...
			array(
				'_id' => 'h1',
				'title' => esc_html__( 'H1', 'prana-yoga' ),
				$typography_key => 'custom',
			...
			array(
				'_id' => 'h2',
				'title' => esc_html__( 'H2', 'prana-yoga' ),
				$typography_key => 'custom',
			...
			array(
				'_id' => 'h3',
				'title' => esc_html__( 'H3', 'prana-yoga' ),
				$typography_key => 'custom',
			...
			array(
				'_id' => 'h4',
				'title' => esc_html__( 'H4', 'prana-yoga' ),
				$typography_key => 'custom',
			...
			array(
				'_id' => 'h5',
				'title' => esc_html__( 'H5', 'prana-yoga' ),
				$typography_key => 'custom',
			...
			array(
				'_id' => 'h6',
				'title' => esc_html__( 'H6', 'prana-yoga' ),
				$typography_key => 'custom',
			...
			array(
				'_id' => 'button',
				'title' => esc_html__( 'Button', 'prana-yoga' ),
				$typography_key => 'custom',
			...
			array(
				'_id' => 'blockquote',
				'title' => esc_html__( 'Blockquote', 'prana-yoga' ),
				$typography_key => 'custom',
