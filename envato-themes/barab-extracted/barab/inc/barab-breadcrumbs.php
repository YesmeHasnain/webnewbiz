...
if ( ! function_exists( 'barab_breadcrumbs' ) ) {
    function barab_breadcrumbs( $args = array() ) {
        if ( is_front_page() ) {
            return;
        }
        ...
        $defaults  = array(
            ...
            'home_title'          => esc_html__( 'Home', 'barab' )
        );
        $args    = apply_filters( 'barab_breadcrumbs_args', wp_parse_args( $args, $defaults ) );
        ...
        */
        ...
        $html = ''; 
        $html .= '<ul class="breadcumb-menu wow fadeInUp" '.implode( ' ',  $args_el ).'>';
        ...
        if ( is_singular( 'post' ) ) {
            ...
            $html .= '<li class="active bread-search">'.esc_html__('Search results for: ','barab') . get_search_query() . '</li>';
        } elseif ( is_404() ) {
            $html .= '<li>' . esc_html__( 'Error Page', 'barab' ) . '</li>';
        } elseif ( is_home() ) {
        ...
        if( class_exists('woocommerce') ) {
            ...
            echo apply_filters( 'barab_breadcrumbs_filter', $html );
        }
