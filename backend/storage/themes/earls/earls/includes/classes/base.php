...
use EARLS\Includes\Classes\Header_Enqueue;
use EARLS\Includes\Classes\Options;
...
class Base {
	...
	public static function instance() {
		...
		if ( isset( $GLOBALS['earls_base'] ) ) {
			return $GLOBALS['earls_base'];
		}
	...
	function option( $key = '' ) {
		...
		$options = (array) get_theme_mod( 'earls' . '_options-mods' );

		$dn = earls_dot( $options );
