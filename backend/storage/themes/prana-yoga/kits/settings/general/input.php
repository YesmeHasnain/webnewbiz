...
class Input extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Form Fields', 'prana-yoga' );
	}
	...
	protected function register_toggle_controls() {
		$this->add_control(
			'notice',
			array(
				'raw' => esc_html__( 'Used in: default form, Gutenberg editor.', 'prana-yoga' ),
		...
		$this->add_controls_group( '', self::CONTROLS_STATES, array(
			'states' => array(
				...
				'focus' => esc_html__( 'Focus', 'prana-yoga' ),
			),
		) );
		...
		$this->add_control(
			'placeholder_color',
			array(
				'label' => esc_html__( 'Placeholder Color', 'prana-yoga' ),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Label', 'prana-yoga' ),
