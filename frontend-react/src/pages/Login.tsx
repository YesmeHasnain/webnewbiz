      ...
      <div className="auth-container">
        ...
        <div className="auth-left">
          <div className="auth-left-content">
            ...
            <h2 className="auth-left-title">Build websites with AI in seconds</h2>
            <p className="auth-left-desc">Describe your business and get a professional WordPress website instantly.</p>
          </div>
        </div>
