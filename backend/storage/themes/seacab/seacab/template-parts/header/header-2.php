<?php 
   ...
   // contact button
	$seacab_phone_button_text = get_theme_mod( 'seacab_phone_button_text', __( '+5204654544', 'seacab' ) );
   $seacab_phone_button_link = get_theme_mod( 'seacab_phone_button_link', __( '+5204654544', 'seacab' ) );
            ...
            <div class="main-menu-wrapper clearfix">
               ...
               <div class="main-menu-wrapper__right">
                     ...
                     <?php if ( !empty( $seacab_header_right ) ): ?>
                        <?php if ( !empty( $seacab_phone_button_text ) ): ?>
                           <div class="header__phone-btn">
                              ...
                              <div class="content">
                                 <span>Need help?</span>
                                 <h4><a href="tel:<?php echo esc_attr($seacab_phone_button_link); ?>"><?php echo esc_html($seacab_phone_button_text); ?></a></h4>
                              </div>
                           </div>
                        <?php endif; ?>
                     <?php endif; ?>
