...
class Slider_Bullets extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Slider Bullets', 'prana-yoga' );
	}
	...
	protected function register_toggle_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					...
					'dynamic' => esc_html__( 'Dynamic', 'prana-yoga' ),
					'numbered' => esc_html__( 'Numbered', 'prana-yoga' ),
				),
		...
		foreach ( array(
			...
			'active' => esc_html__( 'Active', 'prana-yoga' ),
		) as $key => $label ) {
		...
		$this->add_responsive_control(
			'spacing',
			array(
				'label' => esc_html__( 'Spacing', 'prana-yoga' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => array( 'px' ),
				'range' => array(
					'px' => array(
