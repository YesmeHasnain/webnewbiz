<?php
namespace PranaYogaSpace\Kits\Settings\FooterWidgets;
...
class Footer_Widgets extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Footer Widgets', 'prana-yoga' );
	}
	...
	protected function register_toggle_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					'show' => esc_html__( 'Show On All Devices', 'prana-yoga' ),
					'hide_tablet' => esc_html__( 'Hide On Tablet And Less', 'prana-yoga' ),
					'hide_mobile' => esc_html__( 'Hide On Mobile', 'prana-yoga' ),
					'hide' => esc_html__( 'Hide On All Devices', 'prana-yoga' ),
				),
		...
		$this->add_control(
			...
			array_merge_recursive(
				...
				array(
					'label' => esc_html__( 'Columns', 'prana-yoga' ),
					'label_block' => true,
					'description' => esc_html__( 'This setting will be applied after save and reload.', 'prana-yoga' ),
					...
					'options' => array(
						'1' => array(
							'title' => '1',
							'description' => esc_html__( 'One', 'prana-yoga' ),
						),
						'2' => array(
							'title' => '2',
							'description' => esc_html__( 'Two', 'prana-yoga' ),
						),
						'3' => array(
							'title' => '3',
							'description' => esc_html__( 'Three', 'prana-yoga' ),
						),
						'4' => array(
							'title' => '4',
							'description' => esc_html__( 'Four', 'prana-yoga' ),
						),
						'5' => array(
							'title' => '5',
							'description' => esc_html__( 'Five', 'prana-yoga' ),
						),
					),
					'toggle' => false,
					'default' => $this->get_default_setting(
		...
		$this->start_controls_tab(
			...
			array(
				'label' => esc_html__( 'Desktop', 'prana-yoga' ),
			)
		);
		...
		$this->add_control(
			'layout_2',
			array(
				'label' => esc_html__( 'Layout', 'prana-yoga' ),
				'label_block' => false,
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'prana-yoga' ),
				'type' => Controls_Manager::SELECT,
				'options' => array(
		...
		$this->add_control(
			...
			array(
				'label_block' => true,
				'show_label' => false,
				'raw' => esc_html__( 'Layout for this columns count will be', 'prana-yoga' ) . '<br />1/5 + 1/5 + 1/5 + 1/5 + 1/5',
				'type' => Controls_Manager::RAW_HTML,
		...
		$this->start_controls_tab(
			...
			array(
				'label' => esc_html__( 'Tablet', 'prana-yoga' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Columns in Row', 'prana-yoga' ),
				'label_block' => true,
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'prana-yoga' ),
				'type' => CmsmastersControls::CHOOSE_TEXT,
				'options' => array(
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Reverse Columns', 'prana-yoga' ),
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'prana-yoga' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'No', 'prana-yoga' ),
				'label_on' => esc_html__( 'Yes', 'prana-yoga' ),
				'default' => $this->get_default_setting(
		...
		$this->add_control(
			'tablet_hide_1',
			array(
				'label' => esc_html__( 'Hide "Footer 1" widgets area', 'prana-yoga' ),
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'prana-yoga' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'No', 'prana-yoga' ),
				'label_on' => esc_html__( 'Yes', 'prana-yoga' ),
		...
		$this->add_control(
			'tablet_hide_2',
			array(
				'label' => esc_html__( 'Hide "Footer 2" widgets area', 'prana-yoga' ),
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'prana-yoga' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'No', 'prana-yoga' ),
				'label_on' => esc_html__( 'Yes', 'prana-yoga' ),
		...
		$this->add_control(
			'tablet_hide_3',
			array(
				'label' => esc_html__( 'Hide "Footer 3" widgets area', 'prana-yoga' ),
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'prana-yoga' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'No', 'prana-yoga' ),
				'label_on' => esc_html__( 'Yes', 'prana-yoga' ),
		...
		$this->add_control(
			'tablet_hide_4',
			array(
				'label' => esc_html__( 'Hide "Footer 4" widgets area', 'prana-yoga' ),
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'prana-yoga' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'No', 'prana-yoga' ),
				'label_on' => esc_html__( 'Yes', 'prana-yoga' ),
		...
		$this->add_control(
			'tablet_hide_5',
			array(
				'label' => esc_html__( 'Hide "Footer 5" widgets area', 'prana-yoga' ),
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'prana-yoga' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'No', 'prana-yoga' ),
				'label_on' => esc_html__( 'Yes', 'prana-yoga' ),
		...
		$this->start_controls_tab(
			...
			array(
				'label' => esc_html__( 'Mobile', 'prana-yoga' ),
			)
		);
		...
		$this->add_responsive_control(
			'columns_gap',
			array(
				'label' => esc_html__( 'Columns Gap', 'prana-yoga' ),
		...
		$this->add_responsive_control(
			'widgets_gap',
			array(
				'label' => esc_html__( 'Widgets Gap Between', 'prana-yoga' ),
				'type' => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'min' => 0,
