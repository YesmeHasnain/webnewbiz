    ...
    <div class="container-fluid">
        ...
        <h1 class="blog-title">
            <?php if (is_front_page()) {
                    echo esc_html__('Home', 'mancink');
                } else if (is_category()) {
                    echo esc_html__('Archive by category: ', 'mancink') . single_cat_title('', false);
                } else if (is_tag()) {
                    echo esc_html__('Posts tagged: ', 'mancink') . single_tag_title('', false);
                } ?>
        </h1>
    </div>
            ...
            <div class="blog-content
                ...
                <div class="zpd-pagi-outer">
                    <ul class="pagination clearfix">
                        <li><?php previous_posts_link(esc_html__('Previous Page', 'mancink')); ?></li>
                        <li><?php next_posts_link(esc_html__('Next Page', 'mancink')); ?> </li>
                    </ul>
                </div>
            </div>
            <!--/.col-md-8-->
