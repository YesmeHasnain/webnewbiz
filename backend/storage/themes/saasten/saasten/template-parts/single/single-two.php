			...
			<article id="post-<?php the_ID(); ?>" <?php post_class(["post-content", "post-single"]); ?>>
				...
				<div class="blog_layout_one_Top">
					<div class="post-header-style1">
						...
						<?php require SAASTEN_THEME_DIR . '/template-parts/cat-color.php'; ?>
						</div>
						<?php endif; ?>	
							...
							<div class="single-meta-left-infos">
								...
								<div class="single-meta-content">
									...
									<ul class="single-top-meta-list">
										...
										<li class="blog_details__Readtime"><?php echo saasten_reading_time(); ?></li>
										
										<?php if($blog_single_views == true) :?>
										
										<li class="blog_details__Views">
										<?php saasten_set_post_view();?>
										<?php echo saasten_get_post_view(); ?><?php esc_html_e(' Views', 'saasten'); ?>
										</li>
