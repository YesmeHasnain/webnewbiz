			...
			<div class="row">
				<div class="col-lg-12">
					<div class="tp-blog-heading p-relative pb-70">
						<?php if (!empty($nixer_redux_demo['blog-heading'])): ?>
							<span class="tp-breadcrumb-subtitle"><?php echo wp_specialchars_decode(esc_attr($nixer_redux_demo['blog-heading']));?></span>
						<?php endif ?>
						<h3 class="tp-breadcrumb-title tp-title-anim">
							<?php if(isset($nixer_redux_demo['blog-title']) && $nixer_redux_demo['blog-title']!=''){?>
								<?php echo wp_specialchars_decode(esc_attr($nixer_redux_demo['blog-title']));?>
							<?php }else{?>
								<?php echo esc_html__( 'Blog', 'nixer' );
							}?>
						</h3>
						<?php if (!empty($nixer_redux_demo['blog-text'])): ?>
							<div class="tp-blog-inner-heading blog z-index-1">
								<p><?php echo wp_specialchars_decode(esc_attr($nixer_redux_demo['blog-text']));?></p>
							</div>
						<?php endif ?>
					</div>
				</div>
			...
			<?php } ?>
					<div class="postbox__wrapper">
						...
						?>
							...
							<?php endif ?>
							<article class="postbox__item p-relative mb-80">
								...
								<div class="postbox__content">
									...
									<div class="postbox__read-more">
										<a href="<?php the_permalink(); ?>" class="tp-btn-border-lg">
											<?php if(isset($nixer_redux_demo['blog-btn-read']) && $nixer_redux_demo['blog-btn-read']!=''){?>
												<?php echo wp_specialchars_decode(esc_attr($nixer_redux_demo['blog-btn-read']));?>
											<?php }else{?>
