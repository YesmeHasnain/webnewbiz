<?php
namespace PranaYogaSpace\Admin\Upgrader;

use PranaYogaSpace\Admin\Upgrader\Upgrader_Utils;
...
class Upgrader {
	...
	public function __construct() {
		...
		update_option( 'cmsmasters_prana-yoga_clear_cache', 'pending', false );
	...
	public function run_upgrades() {
		...
		foreach ( Theme_Config::MAJOR_VERSIONS as $major_version ) {
			...
			$class_name = 'PranaYogaSpace\\ThemeConfig\\UpgraderVersions\\Version_' . str_replace( array( '.', '-' ), '', $major_version );
	...
	public function clear_cache() {
		if (
			'pending' !== get_option( 'cmsmasters_prana-yoga_clear_cache' ) ||
		...
		add_action( 'elementor/init', function() {
			...
			delete_option( 'cmsmasters_prana-yoga_clear_cache' );
		} );
	}
