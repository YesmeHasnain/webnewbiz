                        ...
                        <h1 class="page-title">
                            <?php if($content_banner !=''){
                               echo esc_html($content_banner);
                                    ...
                                    if(!empty($startli_option['blog_title'])) { ?>
                                        <?php echo esc_html($startli_option['blog_title']);?>
                                        <?php }
                                        else{
                                         esc_html_e('Blog','startli');
                                    } 
                                }
                            ?>
                        </h1>
...
<?php }
    elseif(!empty($startli_option['blog_banner_main']['url'])) { ?>
    ...
    <div class="<?php echo esc_attr($header_width);?>">
      <div class="row">
        <div class="col-md-12">
            <div class="breadcrumbs-inner bread-<?php echo esc_attr($post_menu_type); ?>">
                <?php     
                    if(!empty($startli_option['off_breadcrumb'])){
                        $rs_breadcrumbs = get_post_meta(get_queried_object_id(), 'select-bread', true);
                        if( $rs_breadcrumbs != 'hide' ):        
                            if(function_exists('bcn_display')){?>
                                <div class="breadcrumbs-title"> <?php  bcn_display();?></div>
