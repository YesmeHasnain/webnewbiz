...
class WordPressService
{
    ...
    /** Detect installed Elementor version from template or plugin file */
    public static function detectElementorVersion(): string
    {
        ...
        // Parse from template plugin header
        $mainFile = "{$templateDir}/wp-content/plugins/elementor/elementor.php";
...
HTACCESS;
    ...
    private function createElementorKit(\PDO $pdo, string $dbName): void
    {
        ...
        if ($kitId) {
            ...
            $this->setPostMeta($pdo, $kitId, '_elementor_version', self::detectElementorVersion());
...
// Redirect to wp-admin (or custom redirect path)
    ...
    public function createElementorPage(Website $website, string $title, string $htmlContent, array $elementorData, string $pageTemplate = 'default'): array
    {
        ...
        try {
            ...
            if (!empty($elementorData)) {
                ...
                $this->setPostMeta($pdo, $postId, '_elementor_version', self::detectElementorVersion());
