...
function wnb_theme_setup() {
    ...
    register_nav_menus(['header_menu' => __('Header Menu', 'wnb-ember'), 'footer_menu' => __('Footer Menu', 'wnb-ember')]);
...
function wnb_theme_scripts() {
    wp_enqueue_style('wnb-fonts', 'https://fonts.googleapis.com/css2?family=Bitter:wght@400;500;600;700&family=Cabin:wght@400;500;600;700&display=swap', [], null);
