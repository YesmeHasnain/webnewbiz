    ...
    private static function getUserSubscriptionInfo(){
        ...
        if ( class_exists( '\Tenweb_Manager\Manager' ) ) {
            ...
            if ( is_array($user_agreements_info) && !empty($user_agreements_info) ) {
                $agreement_info = isset( $user_agreements_info['agreement_info'] ) ? $user_agreements_info['agreement_info'] : array();
                $is_trial = isset($agreement_info['subscription_category']) && $agreement_info['subscription_category'] === 'starter';
                $is_monthly = isset($agreement_info['plan']['period_type']) && $agreement_info['plan']['period_type'] === 'm';
