...
function wnb_theme_setup() {
    ...
    register_nav_menus(['header_menu' => __('Header Menu', 'wnb-corporate'), 'footer_menu' => __('Footer Menu', 'wnb-corporate')]);
...
function wnb_theme_scripts() {
    wp_enqueue_style('wnb-fonts', 'https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;500;600;700;800&family=Lato:wght@300;400;700&display=swap', [], null);
