(function ($) {
  ...
  $(".for-sticky").on("sticky-start", function () {
    ...
    $(this).find(".mancink-nav,.box-mobile").addClass("mancink-stick");
  });
  $(".for-sticky").on("sticky-end", function () {
    $(this).removeClass("mancink-sticky-menu");
    $(this).find(".mancink-nav,.box-mobile").removeClass("mancink-stick");
  });
  ...
  $(
    ...
    $(this).find(".elementor-widget-container").addClass("hovering");
  });
})(jQuery);
