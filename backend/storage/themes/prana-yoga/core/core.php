<?php
namespace PranaYogaSpace\Core;

use PranaYogaSpace\Admin\Admin;
use PranaYogaSpace\Core\Traits\Singleton;
use PranaYogaSpace\Core\Utils\File_Manager;
use PranaYogaSpace\Core\Utils\Utils;
use PranaYogaSpace\Kits\Module as Kits;
use PranaYogaSpace\Modules\Modules;
use PranaYogaSpace\TemplateFunctions\General_Elements;
use PranaYogaSpace\TemplateFunctions\Main_Elements;
use PranaYogaSpace\ThemeConfig\Theme_Config;
use PranaYogaSpace\ThemeConfig\Theme_Plugins;
...
class Core {
	...
	public function get_responsive_stylesheet_templates( $templates ) {
		...
		foreach ( $templates_paths as $template_path ) {
			$file_name = 'prana-yoga-' . basename( $template_path );
	...
	public function enqueue_frontend_assets() {
		...
		wp_localize_script( 'prana-yoga-frontend', 'cmsmasters_localize_vars', array(
	...
	public function register_widget_areas() {
		...
		register_sidebar(
			array(
				'name' => esc_html__( 'Sidebar', 'prana-yoga' ),
				'id' => 'sidebar_default',
				'description' => esc_html__( 'Widgets in this area will be shown in all left and right sidebars.', 'prana-yoga' ),
		...
		register_sidebar(
			array(
				'name' => esc_html__( 'Archive Sidebar', 'prana-yoga' ),
				'id' => 'sidebar_archive',
				'description' => esc_html__( 'Widgets in this area will be shown in all left and right sidebars on archives pages.', 'prana-yoga' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget' => '</aside>',
				'before_title' => '<h6 class="widgettitle">',
				'after_title' => '</h6>',
		...
		register_sidebar(
			array(
				'name' => esc_html__( 'Search Sidebar', 'prana-yoga' ),
				'id' => 'sidebar_search',
				'description' => esc_html__( 'Widgets in this area will be shown in all left and right sidebars on archives pages.', 'prana-yoga' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget' => '</aside>',
		...
		register_sidebar(
			array(
				'name' => esc_html__( 'Footer 1', 'prana-yoga' ),
				'id' => 'footer-1',
				'description' => esc_html__( 'Widgets in this area will be shown in footer area.', 'prana-yoga' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget' => '</aside>',
				'before_title' => '<h6 class="widgettitle">',
				'after_title' => '</h6>',
		...
		register_sidebar(
			array(
				'name' => esc_html__( 'Footer 2', 'prana-yoga' ),
				'id' => 'footer-2',
				'description' => esc_html__( 'Widgets in this area will be shown in footer area.', 'prana-yoga' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget' => '</aside>',
		...
		register_sidebar(
			array(
				'name' => esc_html__( 'Footer 3', 'prana-yoga' ),
				'id' => 'footer-3',
				'description' => esc_html__( 'Widgets in this area will be shown in footer area.', 'prana-yoga' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget' => '</aside>',
		...
		register_sidebar(
			array(
				'name' => esc_html__( 'Footer 4', 'prana-yoga' ),
				'id' => 'footer-4',
				'description' => esc_html__( 'Widgets in this area will be shown in footer area.', 'prana-yoga' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget' => '</aside>',
		...
		register_sidebar(
			array(
				'name' => esc_html__( 'Footer 5', 'prana-yoga' ),
				'id' => 'footer-5',
				'description' => esc_html__( 'Widgets in this area will be shown in footer area.', 'prana-yoga' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget' => '</aside>',
	...
	public function register_translations() {
		load_theme_textdomain( 'prana-yoga', get_template_directory() . '/theme-config/languages' );
	}
	...
	public function register_nav_menu_locations() {
		register_nav_menus(
			array(
				'header_top_nav' => esc_html__( 'Header Top Navigation', 'prana-yoga' ),
				'header_mid_nav' => esc_html__( 'Header Middle Navigation', 'prana-yoga' ),
				'header_bot_nav' => esc_html__( 'Header Bottom Navigation', 'prana-yoga' ),
				'footer_nav' => esc_html__( 'Footer Navigation', 'prana-yoga' ),
			)
		);
	}
	...
	public function filter_password_form() {
		$output = '<p>' . esc_html__( 'This content is password protected. To view it please enter your password below:', 'prana-yoga' ) . '</p>' .
		'<form action="' . esc_url( site_url( 'wp-login.php?action=postpass', 'login_post' ) ) . '" class="post-password-form cmsmasters-post-password-form" method="post">' .
			'<input name="post_password" type="password" size="20" placeholder="' . esc_attr__( 'Password', 'prana-yoga' ) . '" />' .
			'<input type="submit" name="Submit" value="' . esc_attr_x( 'Enter', 'post password form', 'prana-yoga' ) . '" />' .
		'</form>';
