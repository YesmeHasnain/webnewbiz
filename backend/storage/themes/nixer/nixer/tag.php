				...
				<div class="col-lg-12">
					<div class="tp-blog-heading p-relative pb-70">
						<h3 class="tp-breadcrumb-title tp-title-anim">
							<?php if(isset($nixer_redux_demo['tag-title']) && $nixer_redux_demo['tag-title']!=''){?>
								<?php echo wp_specialchars_decode(esc_attr($nixer_redux_demo['tag-title']));?>
							<?php }else{?>
								<?php echo esc_html__( 'Tag:', 'nixer' );
							}?>
							<span class="text-cap"><?php printf( esc_html__( ' %s', 'nixer' ), single_tag_title( '', false ) );?></span>
						</h3>
					</div>
				</div>
			</div>
								...
								<div class="postbox__content">
									...
									<div class="postbox__read-more">
										<a href="<?php the_permalink(); ?>" class="tp-btn-border-lg">
											<?php if(isset($nixer_redux_demo['tag-btn-read']) && $nixer_redux_demo['tag-btn-read']!=''){?>
												<?php echo wp_specialchars_decode(esc_attr($nixer_redux_demo['tag-btn-read']));?>
											<?php }else{?>
