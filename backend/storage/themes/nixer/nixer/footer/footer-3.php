...
?>
			   	<?php 
				$footer_slug = isset($nixer_redux_demo['f3-select']) ? $nixer_redux_demo['f3-select'] : '';
				if ($footer_slug && empty($nixer_redux_demo['f3-widget-switch'])) {
					...
					<?php if (!empty($nixer_redux_demo['f3-bg-color'])) { ?>
						<section class="tp-footer-4-ptb" data-bg-color="<?php echo esc_attr($nixer_redux_demo['f3-bg-color']); ?>">
					<?php } else { ?>
						<section class="tp-footer-4-ptb" data-bg-color="#1E1E1E">
					<?php } ?>
									...
									<div class="row">
										<div class="col-lg-12 text-center">
											<div class="tp-footer-2-copyright-text">
												<?php if (!empty($nixer_redux_demo['f3-copyright'])) { ?>
													<p><?php echo html_entity_decode($nixer_redux_demo['f3-copyright']); ?></p>
												<?php } else { ?>
