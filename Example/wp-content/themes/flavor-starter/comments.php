...
<div id="comments" class="comments-area">
	...
	if ( have_comments() ) :
		...
		<h2 class="comments-title">
			...
			if ( '1' === $tenweb_builder_theme_comment_count ) {
				...
				printf( // WPCS: XSS OK.
					...
					esc_html( _nx( '%1$s thought on &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', $tenweb_builder_theme_comment_count, 'comments title', 'flavor-starter' ) ),
		...
		<ul class="comment-list">
			<?php wp_list_comments(array('callback' => 'starter_comment', 'style' => 'ul')); ?>
		</ul><!-- .comment-list -->
