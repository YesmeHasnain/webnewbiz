...
?>
			   	<?php 
				$footer_slug = isset($nixer_redux_demo['f6-select']) ? $nixer_redux_demo['f6-select'] : '';
				if ($footer_slug && empty($nixer_redux_demo['f6-widget-switch'])) {
					...
					<section class="tp-footer-4-ptb" data-bg-color="<?php echo esc_attr($nixer_redux_demo['f6-bg-color']); ?>">
								...
								<div class="row">
									<div class="col-lg-12 text-center">
										<div class="tp-footer-2-copyright-text">
											<?php if (!empty($nixer_redux_demo['f6-copyright'])) { ?>
												<p><?php echo html_entity_decode($nixer_redux_demo['f6-copyright']); ?></p>
											<?php } else { ?>
