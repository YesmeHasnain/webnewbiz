...
?>
			   	<?php 
				$footer_slug = isset($nixer_redux_demo['f5-select']) ? $nixer_redux_demo['f5-select'] : '';
				if ($footer_slug && empty($nixer_redux_demo['f5-widget-switch'])) {
					...
					<footer class="tp-footer-8-ptb pb-25" data-bg-color="<?php echo esc_attr($nixer_redux_demo['f5-bg-color']); ?>">
						<div class="container container-1720">
							<div class="row align-items-center">
								<div class="col-md-12 text-center">
									<div class="tp-footer-8-copyright">
										<?php if (!empty($nixer_redux_demo['f5-copyright'])) { ?>
											<p><?php echo html_entity_decode($nixer_redux_demo['f5-copyright']); ?></p>
										<?php } else { ?>
