...
function wnb_theme_setup() {
    ...
    register_nav_menus(['header_menu' => __('Header Menu', 'wnb-flavor'), 'footer_menu' => __('Footer Menu', 'wnb-flavor')]);
...
function wnb_theme_scripts() {
    wp_enqueue_style('wnb-fonts', 'https://fonts.googleapis.com/css2?family=Raleway:wght@300;400;500;600;700&family=Nunito:wght@400;500;600;700&display=swap', [], null);
