   ...
   <div class="container clearfix">
      <div class="sixteen columns">
            <h1 class="title tCenter">
               <?php
                if ( is_day() ) :
                    printf( esc_html__( 'Daily Archives: %s', 'rival' ), get_the_date() );
                elseif ( is_month() ) :
                    printf( esc_html__( 'Monthly Archives: %s', 'rival' ), get_the_date( esc_html_x( 'F Y', 'monthly archives date format', 'rival' ) ) );
                elseif ( is_year() ) :
                    printf( esc_html__( 'Yearly Archives: %s', 'rival' ), get_the_date( esc_html_x( 'Y', 'yearly archives date format', 'rival' ) ) );
                else :
                    echo esc_html__( 'Archives', 'rival' );
                endif;?>
            </h1>
      </div>
