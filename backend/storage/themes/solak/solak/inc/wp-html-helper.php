...
// image default alt
if( !function_exists( 'solak_img_default_alt' ) ){
	function solak_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'solak_img_tag' ) ){
	function solak_img_tag( array $args ){
...
// Anchor Tag
if( !function_exists( 'solak_anchor_tag' ) ){
	function solak_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'solak_heading_tag' ) ){
	function solak_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'solak_paragraph_tag' ) ){
	function solak_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'solak_span_tag' ) ){
	function solak_span_tag( array $args ){
