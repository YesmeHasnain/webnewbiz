<?php
  if (is_home() && !is_front_page() || is_home() && is_front_page()){
		...
		$skew_style        = (!empty($startli_option['skew_off'])) ? 'reactheme-skew-head' : '';
...
$main_menu_center = (!empty($startli_option['main_menu_center'])) || ($menu_center_page == 'yes')  ? 'main-menu-center' : '';

$main_menu_icon = (!empty($startli_option['main_menu_icon'])) ? 'main-menu-icon-hide' : '';
