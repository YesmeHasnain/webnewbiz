...
// image default alt
if( !function_exists( 'barab_img_default_alt' ) ){
	function barab_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'barab_img_tag' ) ){
	function barab_img_tag( array $args ){
...
// Anchor Tag
if( !function_exists( 'barab_anchor_tag' ) ){
	function barab_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'barab_heading_tag' ) ){
	function barab_heading_tag( array $args ){
		...
		// Animate Attribute 
		if( !empty( $args['data-cue'] ) ){
			$attr .= ' data-cue="'.esc_attr( $args['data-cue'] ).'"';
		}
...
// Paragraph Tag
if( !function_exists( 'barab_paragraph_tag' ) ){
	function barab_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'barab_span_tag' ) ){
	function barab_span_tag( array $args ){
