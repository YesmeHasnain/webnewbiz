...
#template_container {
	box-shadow: <?php echo esc_attr($email_improvements_enabled ? 'none' : '0 1px 4px rgba(0, 0, 0, 0.1) !important'); ?>;
	background-color: <?php echo esc_attr( $body ); ?>;
	border: <?php echo esc_attr($email_improvements_enabled ? '0' : '1px solid ' . esc_attr( $bg_darker_10 )); ?>;
...
#template_header {
	...
	font-family: <?php echo esc_attr($safe_font_family); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>;
}
...
#template_footer td {
	padding: 0;
	border-radius: <?php echo esc_attr($email_improvements_enabled ? '0' : '6px'); ?>;
}
...
#template_footer #credit {
	...
	font-family: <?php echo esc_attr($safe_font_family); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>;
	font-size: 12px;
	line-height: <?php echo esc_attr($email_improvements_enabled ? '140%' : '150%'); ?>;
	text-align: center;
	padding: <?php echo esc_attr($email_improvements_enabled ? '32px' : '24px 0'); ?>;
}

#template_footer #credit p {
	margin: <?php echo esc_attr($email_improvements_enabled ? '0' : '0 0 16px'); ?>;
}
...
#body_content table td {
	padding: <?php echo esc_attr($email_improvements_enabled ? '20px 32px 32px' : '48px 48px 32px'); ?>;
}
...
#body_content td ul.wc-item-meta {
	font-size: <?php echo esc_attr($email_improvements_enabled ? '14px' : 'small'); ?>;
	margin: <?php echo esc_attr($email_improvements_enabled ? '0' : '1em 0 0'); ?>;
	padding: 0;
	<?php if ( $email_improvements_enabled ) { ?>
	color: <?php echo esc_attr( $footer_text ); ?>;
	line-height: 140%;
...
#body_content td ul.wc-item-meta li {
	margin: <?php echo esc_attr($email_improvements_enabled ? '0' : '0.5em 0 0'); ?>;
	padding: 0;
}
...
#body_content_inner {
	...
	font-family: <?php echo esc_attr($safe_font_family); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>;
	font-size: <?php echo esc_attr($email_improvements_enabled ? '16px' : '14px'); ?>;
	line-height: 150%;
...
.td {
	color: <?php echo esc_attr( $text_lighter_20 ); ?>;
	border: <?php echo esc_attr($email_improvements_enabled ? '0' : '1px solid ' . esc_attr( $body_darker_10 )); ?>;
	vertical-align: middle;
}
...
#header_wrapper {
	padding: <?php echo esc_attr($email_improvements_enabled ? '20px 32px 0' : '36px 48px'); ?>;
	display: block;
}
...
h1 {
	...
	font-family: <?php echo esc_attr($safe_font_family); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>;
	font-size: <?php echo esc_attr($email_improvements_enabled ? '32px' : '30px'); ?>;
	font-weight: <?php echo esc_attr($email_improvements_enabled ? 700 : 300); ?>;
	<?php if ( $email_improvements_enabled ) : ?>
		letter-spacing: -1px;
	<?php endif; ?>
	line-height: <?php echo esc_attr($email_improvements_enabled ? '120%' : '150%'); ?>;
	margin: 0;
	text-align: <?php echo is_rtl() ? 'right' : 'left'; ?>;
	<?php if ( ! $email_improvements_enabled ) : ?>
...
h2 {
	...
	display: block;
	font-family: <?php echo esc_attr($safe_font_family); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>;
	font-size: <?php echo esc_attr($email_improvements_enabled ? '20px' : '18px'); ?>;
	font-weight: bold;
	line-height: <?php echo esc_attr($email_improvements_enabled ? '160%' : '130%'); ?>;
	margin: 0 0 18px;
	text-align: <?php echo is_rtl() ? 'right' : 'left'; ?>;
}
...
img {
	...
	vertical-align: middle;
	margin-<?php echo is_rtl() ? 'left' : 'right'; ?>: <?php echo esc_attr($email_improvements_enabled ? '24px' : '10px'); ?>;
	max-width: 100%;
}
