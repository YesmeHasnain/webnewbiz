	...
	protected function controls_group_post_media( $key = '', $args = array() ) {
		...
		if ( $media_size_tabs ) {
			...
			$this->start_controls_tab(
				...
				array( 'label' => esc_html__( 'Image', 'prana-yoga' ) )
			);
			...
			$this->start_controls_tab(
				...
				array( 'label' => esc_html__( 'Gallery', 'prana-yoga' ) )
			);
			...
			$this->start_controls_tab(
				...
				array( 'label' => esc_html__( 'Video', 'prana-yoga' ) )
			);
				...
				array_merge_recursive(
					...
					array(
						...
						'fields_options' => array(
							'size' => array( 'label' => esc_html__( 'Gallery Image Size', 'prana-yoga' ) ),
						),
						'default' => $this->get_default_setting(
							$this->get_control_name_parameter( $key, 'gallery_image_size' ),
							'large'
			...
			$this->add_control(
				...
				array_merge_recursive(
					$default_args,
					array(
						'label' => esc_html__( 'Video Height', 'prana-yoga' ),
						'type' => Controls_Manager::SLIDER,
						'range' => array(
							'%' => array(
								'min' => 0,
