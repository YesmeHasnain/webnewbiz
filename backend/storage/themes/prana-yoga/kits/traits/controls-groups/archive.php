	...
	protected function controls_group_archive( $key = '', $args = array() ) {
		...
		$this->add_control(
			...
			array_merge_recursive(
				...
				array(
					...
					'options' => array(
						'l-sidebar' => array(
							'title' => esc_html__( 'Left', 'prana-yoga' ),
							'description' => esc_html__( 'Left Sidebar', 'prana-yoga' ),
						),
						'fullwidth' => array(
							'title' => esc_html__( 'Full', 'prana-yoga' ),
							'description' => esc_html__( 'Full Width', 'prana-yoga' ),
						),
						'r-sidebar' => array(
							'title' => esc_html__( 'Right', 'prana-yoga' ),
							'description' => esc_html__( 'Right Sidebar', 'prana-yoga' ),
						),
					),
		...
		$this->add_control(
			...
			array_merge_recursive(
				...
				array(
					...
					'type' => CmsmastersControls::CHOOSE_TEXT,
					'options' => array(
						'large' => esc_html__( 'Large', 'prana-yoga' ),
						'grid' => esc_html__( 'Grid', 'prana-yoga' ),
						'compact' => esc_html__( 'Compact', 'prana-yoga' ),
					),
					'default' => $this->get_default_setting(
						$this->get_control_name_parameter( $key, 'type' ),
						'large'
		...
		$this->add_control(
			...
			array_merge_recursive(
				...
				array(
					...
					'options' => array(
						'media' => esc_html__( 'Media', 'prana-yoga' ),
						'title' => esc_html__( 'Title', 'prana-yoga' ),
						'meta_first' => esc_html__( 'Meta Data 1', 'prana-yoga' ),
						'meta_second' => esc_html__( 'Meta Data 2', 'prana-yoga' ),
						'content' => esc_html__( 'Content', 'prana-yoga' ),
						'more' => esc_html__( 'Read More', 'prana-yoga' ),
					),
					'default' => $this->get_default_setting(
						$this->get_control_name_parameter( $key, 'large_elements' ),
						array(
		...
		$this->add_control(
			...
			array_merge_recursive(
				...
				array(
					...
					'type' => CmsmastersControls::CHOOSE_TEXT,
					'options' => array(
						'fit-rows' => esc_html__( 'Fit Rows', 'prana-yoga' ),
						'masonry' => esc_html__( 'Masonry', 'prana-yoga' ),
					),
					'default' => $this->get_default_setting(
						$this->get_control_name_parameter( $key, 'grid_style' ),
						'masonry'
		...
		$this->add_control(
			...
			array_merge_recursive(
				...
				array(
					'label' => esc_html__( 'Media', 'prana-yoga' ),
					'type' => Controls_Manager::HEADING,
					'separator' => 'before',
				)
			)
				...
				array(
					...
					'options' => array(
						'flex-start' => array(
							...
							'title' => esc_html__( 'Top', 'prana-yoga' ),
						),
						'center' => array(
						...
						'flex-end' => array(
							...
							'title' => esc_html__( 'Bottom', 'prana-yoga' ),
						),
					),
					'toggle' => false,
					'selectors' => array(
