...
function vamtam_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'     => esc_html__( 'WooCommerce', 'lafeminite' ),
			'slug'     => 'woocommerce',
			'required' => true,
			'category' => 'required',
		),
		...
		array(
			'name'     => esc_html__( 'Smash Balloon Social Photo Feed', 'lafeminite' ),
			'slug'     => 'instagram-feed',
			'required' => true,
			'category' => 'required',
		),
		...
		array(
			'name'     => esc_html__( 'Elementor', 'lafeminite' ),
			'slug'     => 'elementor',
			'required' => true,
			'category' => 'required',
			'version'  => '2.7.4',
		...
		array(
			'name'     => esc_html__( 'Vamtam Elementor Integration (B)', 'lafeminite' ),
			'slug'     => 'vamtam-elementor-integration-b',
			'source'   => VAMTAM_PLUGINS . 'vamtam-elementor-integration-b.zip',
			'required' => true,
			'category' => 'required',
			'version'  => '1.0.0',
		),
		...
		array(
			'name'     => esc_html__( 'Ally - Web Accessibility & Usability', 'lafeminite' ),
		...
		array(
			'name'     => esc_html__( 'Vamtam Importers (E)', 'lafeminite' ),
		...
		array(
			'name'     => esc_html__( 'Wordpress SEO', 'lafeminite' ),
			'slug'     => 'wordpress-seo',
			'required' => false,
			'category' => 'recommended',
		),
		...
		array(
			'name'     => esc_html__( 'Really Simple SSL', 'lafeminite' ),
		...
		array(
			'name'     => esc_html__( 'Loco Translate', 'lafeminite' ),
			'slug'     => 'loco-translate',
			'required' => false,
			'category' => 'recommended',
		),
		...
		array(
			'name'     => esc_html__( 'UpDraftPlus', 'lafeminite' ),
			'slug'     => 'updraftplus',
			'required' => false,
			'category' => 'recommended',
		),
		...
		array(
			'name'     => esc_html__( 'LiteSpeed Cache', 'lafeminite' ),
		...
		array(
			'name'     => esc_html__( 'Limit Login Attempts Reloaded', 'lafeminite' ),
		...
		array(
			'name'     => esc_html__( 'Wordfence', 'lafeminite' ),
			'slug'     => 'wordfence',
			'required' => false,
			'category' => 'recommended',
		),
		...
		array(
			'name'     => esc_html__( 'CookieYes | GDPR Cookie Consent & Compliance Notice (CCPA Ready)', 'lafeminite' ),
...
function vamtam_tgmpa_table_columns( $columns ) {
	...
	$columns = array(
		...
		'img'         => '',
		'plugin'      => esc_html__( 'Name', 'lafeminite' ),
		'description' => esc_html__( 'Description', 'lafeminite' ),
		'status'      => esc_html__( 'Status', 'lafeminite' ),
		'version'     => esc_html__( 'Version', 'lafeminite' ),
	);
	return $columns;
}
...
function vamtam_tgmpa_table_data_item( $item, $plugin )
{
	...
	$recommended_plugins_no_store_img = array(
		...
		'vamtam-elementor-integration-b',
		'vamtam-importers-e',
	...
	if( isset( $plugin_data['Description'] ) ) {
		...
		$item['description'] =  esc_html__( 'A simple WordPress Plugin.', 'lafeminite' );
	}
	if ( strpos( $plugin['slug'], 'lafeminite' ) !== false ) {
		$item['description'] =  esc_html__( 'Theme Exclusive.', 'lafeminite' );
	}
...
function vamtam_tgmpa_admin_menu_args( $args ) {
	$args['page_title'] = esc_html__( 'Install Plugins', 'lafeminite' );
