...
<div class="box-crumb clearfix">
    ...
    <div class="container-fluid">
        ...
        <h1 class="blog-title">
            <?php echo esc_html__('Search results for: ', 'mancink') . get_search_query(); ?></h1>
...
<div class="content blog-wrapper">
    ...
    <?php if (have_posts()) : ?>
        ...
        <div class="not-found clearfix">
            ...
            <h2><?php esc_html_e('Not found!', 'mancink'); ?></h2>
            <p><?php esc_html_e('Sorry, no results found, try a different search. ', 'mancink'); ?></p>
