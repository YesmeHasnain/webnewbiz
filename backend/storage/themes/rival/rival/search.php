   ...
   <div class="container clearfix">
      <div class="sixteen columns">
            <h1 class="title tCenter">
               <?php printf( esc_html__( 'Search Results for: %s', 'rival' ), get_search_query() ); ?>
            </h1>
      </div>
      <div class="eleven columns">
         ...
         <?php endwhile; else : ?>
            <div class="search-custom" >
               <h4 class="mb-20">
                   <?php echo esc_html__( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'rival' ) ;?>
               </h4>
               <form action="<?php echo esc_url(home_url('/')); ?>" class="sidebar__search-form">
                   <input type="search" name="s" placeholder="<?php echo esc_attr__('Search here', 'rival' );?>">
