<?php
/**
 * flavor-starter Theme Customizer
 *
...
function starter_customize_preview_js() {
	wp_enqueue_script( 'flavor-starter-customizer', get_template_directory_uri() . '/assets/js/customizer.js', array( 'customize-preview' ), starter_VERSION, true );
}
