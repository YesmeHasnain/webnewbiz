...
class More_Posts extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'More Posts', 'prana-yoga' );
	}
	...
	protected function register_toggle_controls() {
		$this->add_control(
			...
			array(
				...
				'placeholder' => esc_html__( 'More Posts', 'prana-yoga' ),
			)
		);
		...
		$this->add_control(
			'more_posts_order',
			array(
				'label' => esc_html__( 'Order by', 'prana-yoga' ),
				'label_block' => false,
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'prana-yoga' ),
				'type' => Controls_Manager::SELECT,
				'options' => array(
					'recent' => esc_html__( 'Recent', 'prana-yoga' ),
					'category' => esc_html__( 'Related by Categories', 'prana-yoga' ),
					'post_tag' => esc_html__( 'Related by Tags', 'prana-yoga' ),
				),
				'default' => $this->get_default_setting(
		...
		$this->add_control(
			'more_posts_count',
			array(
				'label' => esc_html__( 'Count', 'prana-yoga' ),
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'prana-yoga' ),
