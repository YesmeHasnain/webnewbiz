...
// Demo import Files
function siberia_demo_import_files() {
	return array(
	  	array(
		  	'import_file_name'           => 'Siberia Demo Import',
		  	'import_file_url'            => 'https://theme.madsparrow.me/siberia/import/siberia-demo.xml',
		  	'import_widget_file_url'     => 'https://theme.madsparrow.me/siberia/import/widgets.wie',
			'import_customizer_file_url' => 'https://theme.madsparrow.me/siberia/import/customizer.dat',
	  	),
	);
}
add_filter( 'pt-ocdi/import_files', 'siberia_demo_import_files' );

// Disable regenerate thumbnails
add_filter( 'pt-ocdi/regenerate_thumbnails_in_content_import', '__return_false' );

// After setup function
if ( ! function_exists( 'siberia_after_import_setup' ) ) {
	function siberia_after_import_setup() {
		...
		// Set pages
		$front_page = get_page_by_title( 'Landing Page' );
...
add_action( 'pt-ocdi/after_import', 'siberia_after_import_setup' );
