<?php
namespace PranaYogaSpace\Kits\Documents;

use PranaYogaSpace\Kits\Module as KitsModule;
use PranaYogaSpace\Kits\Settings\Base\Base_Section;
...
class Kit extends BaseKit {
	...
	public function localize_settings( $settings ) {
		$settings = array_replace_recursive( $settings, array(
			'i18n' => array(
				'cmsmasters_theme' => esc_html__( 'Theme Settings', 'prana-yoga' ),
				'design_system' => esc_html__( 'Design System', 'prana-yoga' ),
				'theme_style' => esc_html__( 'Theme Style', 'prana-yoga' ),
				'settings' => esc_html__( 'Settings', 'prana-yoga' ),
				'additional_settings' => esc_html__( 'Additional Settings', 'prana-yoga' ),
			),
		) );
