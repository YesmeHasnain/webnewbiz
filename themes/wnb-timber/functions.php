...
function wnb_theme_setup() {
    ...
    register_nav_menus(['header_menu' => __('Header Menu', 'wnb-timber'), 'footer_menu' => __('Footer Menu', 'wnb-timber')]);
...
function wnb_theme_scripts() {
    wp_enqueue_style('wnb-fonts', 'https://fonts.googleapis.com/css2?family=Vollkorn:wght@400;500;600;700&family=PT+Sans:wght@400;700&display=swap', [], null);
