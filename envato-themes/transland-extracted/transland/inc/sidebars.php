...
function transland_widgets_init() {
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'transland' ),
			'id'            => 'blog_sidebar',
			'description'   => esc_html__( 'Add widgets here.', 'transland' ),
    ...
    if ( class_exists('ReduxFrameworkPlugin') ) {
        register_sidebar( array(
            'name'          => esc_html__( 'Footer Widgets', 'transland' ),
            'id'            => 'footer_widgets',
            'description'   => esc_html__( 'Add widgets here.', 'transland' ),
...
add_action( 'widgets_init', 'transland_widgets_init' );
