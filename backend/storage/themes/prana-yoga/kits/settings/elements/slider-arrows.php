<?php
namespace PranaYogaSpace\Kits\Settings\Elements;
...
class Slider_Arrows extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Slider Arrows', 'prana-yoga' );
	}
	...
	protected function register_toggle_controls() {
		$this->add_control(
			'notice',
			array(
				'raw' => esc_html__( 'Used in: more posts, single post gallery, archive post gallery.', 'prana-yoga' ),
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					'always' => esc_html__( 'Always', 'prana-yoga' ),
					'hover' => esc_html__( 'On Hover', 'prana-yoga' ),
				),
				'toggle' => false,
		...
		foreach ( array(
			'prev' => esc_html__( 'Previous', 'prana-yoga' ),
			'next' => esc_html__( 'Next', 'prana-yoga' ),
		) as $key => $label ) {
			$is_prev = 'prev' === $key;
			...
			$this->add_control(
				"{$key}_text",
				array(
					'label' => esc_html__( 'Text', 'prana-yoga' ),
					'description' => esc_html__( 'This setting will be applied after save and reload.', 'prana-yoga' ),
			...
			$this->add_control(
				"{$key}_icon_position",
				array(
					'label' => esc_html__( 'Icon Position', 'prana-yoga' ),
					'description' => esc_html__( 'This setting will be applied after save and reload.', 'prana-yoga' ),
					'type' => Controls_Manager::SELECT,
					'options' => array(
						'before' => esc_html__( 'Before', 'prana-yoga' ),
						'after' => esc_html__( 'After', 'prana-yoga' ),
					),
					'default' => $this->get_default_setting(
		...
		$this->add_control(
			'text_direction',
			array(
				'label' => esc_html__( 'Text Direction', 'prana-yoga' ),
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'prana-yoga' ),
				'type' => Controls_Manager::SELECT,
				'options' => array(
					'horizontal' => esc_html__( 'Horizontal', 'prana-yoga' ),
					'vertical' => esc_html__( 'Vertical', 'prana-yoga' ),
				),
				'default' => $this->get_default_setting(
		...
		foreach ( array(
			'normal' => esc_html__( 'Normal', 'prana-yoga' ),
			'hover' => esc_html__( 'Hover', 'prana-yoga' ),
		) as $key => $label ) {
			$this->start_controls_tab(
				"states_{$key}_tab",
				array( 'label' => $label )
			...
			$this->add_control(
				"{$key}_colors_bd",
				array(
					'label' => esc_html__( 'Border', 'prana-yoga' ),
					'type' => Controls_Manager::COLOR,
					'dynamic' => array(),
					'selectors' => array(
		...
		$this->add_var_group_control( '', self::VAR_BORDER, array(
			'fields_options' => array(
				'width' => array( 'label' => esc_html__( 'Border Width', 'prana-yoga' ) ),
			),
			'separator' => 'before',
			'exclude' => array( 'color' ),
		) );
		...
		$this->add_control(
			'bd_radius',
			array(
				'label' => esc_html__( 'Border Radius', 'prana-yoga' ),
		...
		$this->add_responsive_control(
			'icon_size',
			array(
				'label' => esc_html__( 'Icon Size', 'prana-yoga' ),
				'type' => Controls_Manager::SLIDER,
		...
		$this->add_responsive_control(
			'spacing',
			array(
				'label' => esc_html__( 'Arrows Spacing', 'prana-yoga' ),
				'type' => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'min' => 0,
		...
		$this->add_responsive_control(
			'box_width',
			array(
				'label' => esc_html__( 'Arrows Box Width', 'prana-yoga' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => array( 'px', '%' ),
				'range' => array(
					'%' => array(
		...
		$this->add_responsive_control(
			'box_height',
			array(
				'label' => esc_html__( 'Arrows Box Height', 'prana-yoga' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => array( 'px', '%' ),
				'range' => array(
					'%' => array(
		...
		$this->add_responsive_control(
			'icon_gap',
			array(
				'label' => esc_html__( 'Icon Gap', 'prana-yoga' ),
				'description' => esc_html__( 'Gap Between Icon and Text', 'prana-yoga' ),
				'type' => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'max' => 50,
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Text On Tablet/Mobile', 'prana-yoga' ),
				'label_block' => false,
				'type' => CmsmastersControls::CHOOSE_TEXT,
				'options' => array(
					'flex' => array(
						'title' => esc_html__( 'Show', 'prana-yoga' ),
					),
					'none' => array(
						'title' => esc_html__( 'Hide', 'prana-yoga' ),
					),
				),
				'toggle' => true,
				'selectors' => array(
		...
		$this->add_responsive_control(
			...
			array(
				'label' => esc_html__( 'Container', 'prana-yoga' ),
		...
		$this->add_control(
			'container_position',
			array(
				'label' => esc_html__( 'Position', 'prana-yoga' ),
				'label_block' => false,
		...
		$this->add_responsive_control(
			...
			array(
				'label' => esc_html__( 'Horizontal Alignment', 'prana-yoga' ),
				'label_block' => false,
				'type' => Controls_Manager::CHOOSE,
				'options' => array(
					'flex-start' => array(
						'title' => esc_html__( 'Start', 'prana-yoga' ),
						'icon' => 'eicon-h-align-left',
					),
					'center' => array(
						'title' => esc_html__( 'Center', 'prana-yoga' ),
						'icon' => 'eicon-h-align-center',
					),
					'flex-end' => array(
						'title' => esc_html__( 'End', 'prana-yoga' ),
						'icon' => 'eicon-h-align-right',
					),
					'space-between' => array(
						'title' => esc_html__( 'Space Between', 'prana-yoga' ),
		...
		$this->add_responsive_control(
			...
			array(
				'label' => esc_html__( 'Vertical Alignment', 'prana-yoga' ),
				'label_block' => false,
				'type' => Controls_Manager::CHOOSE,
				'options' => array(
					'flex-start' => array(
					...
					'center' => array(
						'title' => esc_html__( 'Middle', 'prana-yoga' ),
		...
		$this->add_responsive_control(
			'container_margin',
			array(
				'label' => esc_html__( 'Margin', 'prana-yoga' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px' ),
				'selectors' => array(
