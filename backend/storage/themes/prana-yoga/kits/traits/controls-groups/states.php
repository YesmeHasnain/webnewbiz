		...
		foreach ( $states as $state_key => $state_label ) {
			...
			if ( 'gradient' === $background ) {
				$this->add_control(
					...
					array(
						'label' => _x( 'Background Type', 'Background Control', 'prana-yoga' ),
						'type' => Controls_Manager::CHOOSE,
						'options' => array(
							'classic' => array(
								'title' => _x( 'Classic', 'Background Control', 'prana-yoga' ),
								'icon' => 'eicon-paint-brush',
							),
							'gradient' => array(
								'title' => _x( 'Gradient', 'Background Control', 'prana-yoga' ),
								'icon' => 'eicon-barcode',
							),
						),
						'default' => 'classic',
				...
				$this->add_control(
					...
					array(
						'label' => _x( 'Background', 'Background Control', 'prana-yoga' ),
				...
				$this->add_control(
					...
					array(
						'label' => _x( 'Background Location', 'Background Control', 'prana-yoga' ),
				...
				$this->add_control(
					...
					array(
						'label' => _x( 'Second Background', 'Background Control', 'prana-yoga' ),
						'type' => Controls_Manager::COLOR,
						'dynamic' => array(),
						'render_type' => 'ui',
						'condition' => array(
				...
				$this->add_control(
					...
					array(
						'label' => _x( 'Second Background Location', 'Background Control', 'prana-yoga' ),
						'type' => Controls_Manager::SLIDER,
						'size_units' => array( '%' ),
						'default' => array(
							'unit' => '%',
				...
				$this->add_control(
					...
					array(
						'label' => _x( 'Gradient Type', 'Background Control', 'prana-yoga' ),
						'type' => Controls_Manager::SELECT,
						'options' => array(
							'linear' => _x( 'Linear', 'Background Control', 'prana-yoga' ),
							'radial' => _x( 'Radial', 'Background Control', 'prana-yoga' ),
						),
						'default' => 'linear',
						'render_type' => 'ui',
						'condition' => array(
				...
				$this->add_control(
					...
					array(
						'label' => _x( 'Gradient Angle', 'Background Control', 'prana-yoga' ),
						'type' => Controls_Manager::SLIDER,
				...
				$this->add_control(
					...
					array(
						'label' => _x( 'Gradient Position', 'Background Control', 'prana-yoga' ),
						'type' => Controls_Manager::SELECT,
						'options' => array(
							'center center' => _x( 'Center Center', 'Background Control', 'prana-yoga' ),
							'center left' => _x( 'Center Left', 'Background Control', 'prana-yoga' ),
							'center right' => _x( 'Center Right', 'Background Control', 'prana-yoga' ),
							'top center' => _x( 'Top Center', 'Background Control', 'prana-yoga' ),
							'top left' => _x( 'Top Left', 'Background Control', 'prana-yoga' ),
							'top right' => _x( 'Top Right', 'Background Control', 'prana-yoga' ),
							'bottom center' => _x( 'Bottom Center', 'Background Control', 'prana-yoga' ),
							'bottom left' => _x( 'Bottom Left', 'Background Control', 'prana-yoga' ),
							'bottom right' => _x( 'Bottom Right', 'Background Control', 'prana-yoga' ),
						),
			...
			if (
				...
				$this->add_control(
					...
					array(
						'label' => esc_html__( 'Text Decoration', 'prana-yoga' ),
						'type' => Controls_Manager::SELECT,
						'options' => array(
							'' => esc_html__( 'Default', 'prana-yoga' ),
							'none' => _x( 'None', 'Typography Control', 'prana-yoga' ),
							'underline' => _x( 'Underline', 'Typography Control', 'prana-yoga' ),
							'overline' => _x( 'Overline', 'Typography Control', 'prana-yoga' ),
							'line-through' => _x( 'Line Through', 'Typography Control', 'prana-yoga' ),
						),
						'selectors' => array(
