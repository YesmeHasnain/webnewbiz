...
if(!function_exists('nova_woo_get_product_per_page_array')){
    function nova_woo_get_product_per_page_array(){
        $per_page_array = apply_filters('bazien/filter/get_product_per_page_array', Nova_OP::getOption('product_per_page_allow'));
...
function nova_set_cookie_default(){
		if (isset($_GET['per_page']) && $per_page = $_GET['per_page']) {
				add_filter('bazien/filter/get_product_per_page','nova_get_parameter_per_page');
		}
}
...
if(!function_exists('nova_woo_get_product_per_page')){
    function nova_woo_get_product_per_page(){
        return apply_filters('bazien/filter/get_product_per_page', Nova_OP::getOption('shop_product_per_page'));
    }
}
if(!function_exists('nova_woo_get_product_per_row')){
    function nova_woo_get_product_per_row(){
        return apply_filters('bazien/filter/get_product_per_row', Nova_OP::getOption('shop_product_columns'));
    }
}
//==============================================================================
    ...
    function nova_woo_custom_info_tab(){
        ...
        echo '<ul class="nova-product-info-mn">';
				...
				if( 1 == Nova_OP::getOption('single_product_size_guide') ) {
					...
					echo '<li class="panel_size_guide"><a data-toggle="SizeGuide">'.$icon_guide.esc_html__( 'Size Guidelines', 'bazien' ).'</a></li>';
				}
				if( 1 == Nova_OP::getOption('single_product_store_availiable') ) {
					...
					echo '<li class="panel_size_guide"><a target="_blank" href="'.esc_url( Nova_OP::getOption('single_product_store_availiable_url') ).'">'.$icon_store.esc_html__( 'Store availability', 'bazien' ).'</a></li>';
				}
				echo '</ul>';
    }
}
