<?php
namespace PranaYogaSpace\Kits\Settings\Main;
...
class Main extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Main', 'prana-yoga' );
	}
	...
	protected function register_toggle_controls() {
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Content', 'prana-yoga' ),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'description' => esc_html__( 'This value will be used for page layouts with sidebar.', 'prana-yoga' ) . '<br />' . esc_html__( 'The width of the sidebar will be equal "100% - this value".', 'prana-yoga' ) . '<br />' . esc_html__( 'For example: 74% - content width, then sidebar width will be 26%.', 'prana-yoga' ) . '<br />' . esc_html__( 'Default value is 74%.', 'prana-yoga' ),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Sidebar', 'prana-yoga' ),
				'type' => Controls_Manager::HEADING,
			)
		);
		...
		$this->add_responsive_control(
			'sidebar_gap',
			array(
				'label' => esc_html__( 'Gap', 'prana-yoga' ),
				'description' => esc_html__( 'Gap between content and sidebar.', 'prana-yoga' ) . '<br />' . esc_html__( 'Default value is 40px.', 'prana-yoga' ) . '<br />' . esc_html__( 'Note: This gap reduces the width of the sidebar.', 'prana-yoga' ),
				'type' => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'min' => 0,
