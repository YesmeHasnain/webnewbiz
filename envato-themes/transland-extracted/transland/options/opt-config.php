...
$args = array(
	...
	'menu_title'           => esc_html__( 'Theme Options', 'transland' ),
	'page_title'           => esc_html__( 'Transland Theme Options', 'transland' ),
	'google_api_key'       => '',
...
$args['footer_text'] = esc_html__( 'Copyright Transland &copy; 2024', 'transland' );

Redux::setArgs( $opt_name, $args );

require get_template_directory().'/options/opt_general.php';
require get_template_directory().'/options/opt_colors.php';
