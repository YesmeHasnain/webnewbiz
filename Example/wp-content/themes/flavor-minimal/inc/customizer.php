<?php
/**
 * flavor-minimal Theme Customizer
 *
...
function minimal_customize_preview_js() {
	wp_enqueue_script( 'flavor-minimal-customizer', get_template_directory_uri() . '/assets/js/customizer.js', array( 'customize-preview' ), minimal_VERSION, true );
}
