<?php
namespace PranaYogaSpace\Kits\Settings\Base;

use PranaYogaSpace\Kits\Traits\Base as KitBaseTraits;
...
abstract class Settings_Tab_Base extends Tab_Base {
	...
	public function get_default_setting( $key, $default = false ) {
		$settings = get_option( 'cmsmasters_prana-yoga_default_kits', array() );
