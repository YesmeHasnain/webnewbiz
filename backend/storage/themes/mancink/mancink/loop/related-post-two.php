...
<?php
$related = mancink_related_post(get_the_ID(), 3);
if ($related->have_posts()) :
    ?>

<div id="related_posts" class="clearfix">
    <div class="rel-inner">
        <p class="rel-sub"><?php esc_html_e('You may also like', 'mancink'); ?></p>
        <h4 class="title-related-post">
            <?php esc_html_e('Other related posts', 'mancink'); ?>
        </h4>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-4 col-xs-12">
            <div class="rl-post-inner">
                ...
                <?php if (class_exists('Kirki') && get_theme_mod('mancink_related_image') == 'show') {  ?>
                <a class="rl-image" href="<?php the_permalink()  ?>" rel="bookmark" title="<?php the_title_attribute(); ?>">
                    <?php the_post_thumbnail('mancink-related-post'); ?>
