...
<form id="order_review" method="post">
	...
	<table class="shop_table">
		<thead>
			<tr>
				<th class="product-name"><?php esc_html_e( 'Product', 'nixer' ); ?></th>
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'nixer' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'nixer' ); ?></th>
			</tr>
		</thead>
		<tbody>
