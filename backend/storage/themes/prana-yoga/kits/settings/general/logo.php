...
class Logo extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Logo', 'prana-yoga' );
	}
	...
	protected function register_toggle_controls() {
		$this->add_control(
			...
			array(
				...
				'options' => array(
					...
					'text' => esc_html__( 'Text', 'prana-yoga' ),
				),
		...
		$this->add_control(
			'retina_toggle',
			array(
				'label' => esc_html__( 'Retina Image', 'prana-yoga' ),
		...
		$this->add_control(
			'second_toggle',
			array(
				'label' => esc_html__( 'Second Logo Image', 'prana-yoga' ),
				'description' => sprintf(
					'%1$s <a href="https://docs.cmsmasters.net/mode-switcher/" target="_blank">%2$s</a>.',
					__( 'Image that will be applied when using the', 'prana-yoga' ),
					__( 'Mode Switcher', 'prana-yoga' )
				),
				'type' => Controls_Manager::POPOVER_TOGGLE,
				'condition' => array(
					$this->get_control_id_parameter( '', 'type' ) => 'image',
		...
		$this->add_control(
			'retina_image_second',
			array(
				'label' => esc_html__( 'Second Retina Logo Image', 'prana-yoga' ),
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'prana-yoga' ),
				'type' => Controls_Manager::MEDIA,
				'default' => array( 'url' => Utils::get_placeholder_image_src() ),
				'condition' => array(
		...
		$this->start_controls_tab(
			'text_title_tab',
			array(
				'label' => esc_html__( 'Title', 'prana-yoga' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'placeholder' => ( get_bloginfo( 'name' ) ? get_bloginfo( 'name' ) : esc_html__( 'Site logo', 'prana-yoga' ) ),
			)
		);
		...
		$this->start_controls_tab(
			'text_subtitle_tab',
			array(
				'label' => esc_html__( 'Subtitle', 'prana-yoga' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'prana-yoga' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'Logo subtitle', 'prana-yoga' ),
			)
		);
