...
add_filter( 'loop_shop_per_page', 'barab_new_loop_shop_per_page', 20 );

function barab_new_loop_shop_per_page( $product_count ) {

    if( class_exists('ReduxFramework') ) { 

        $product_count = barab_opt( 'barab_woo_product_perpage' );
...
add_filter('woocommerce_product_loop_start','barab_woocommerce_product_loop_start');

function barab_woocommerce_product_loop_start( ) {
...
add_filter('woocommerce_product_loop_end','barab_woocommerce_product_loop_end');

function barab_woocommerce_product_loop_end( ) {
...
add_filter('woocommerce_format_sale_price','barab_woocommerce_format_sale_price',10,3);

function barab_woocommerce_format_sale_price( $price, $regular_price, $sale_price ) {
...
add_filter('woocommerce_review_gravatar_size','barab_woocommerce_review_gravatar_size');

function barab_woocommerce_review_gravatar_size() {
...
add_filter('woocommerce_output_related_products_args','barab_woocommerce_output_related_products_args',10,1);

function barab_woocommerce_output_related_products_args( $args ) {

    if( class_exists('ReduxFramework') ) {

        $args['posts_per_page'] = barab_opt('barab_woo_relproduct_num');
...
add_filter('woocommerce_upsell_display_args','barab_woocommerce_upsell_display_args',10,1);

function barab_woocommerce_upsell_display_args( $args ) {

    if( class_exists('ReduxFramework') ) {

        $args['posts_per_page'] = barab_opt('barab_woo_upsellproduct_num');
...
function woocommerce_cross_sells_total( $limit ) {
    ...
    if( class_exists('ReduxFramework') ) {
        ...
        $limit = barab_opt('barab_woo_crosssellproduct_num');
...
add_filter( 'woocommerce_add_to_cart_fragments', 'barab_refresh_mini_cart_count');

function barab_refresh_mini_cart_count($fragments){
...
add_filter( 'woocommerce_checkout_fields' , 'barab_override_checkout_fields' );

function barab_override_checkout_fields( $fields  ){
    ...
    $fields['billing']['billing_first_name']['placeholder'] = esc_attr__('First Name', 'barab');
    ...
    $fields['billing']['billing_last_name']['placeholder'] = esc_attr__('Last Name', 'barab');
    ...
    $fields['billing']['billing_company']['placeholder'] = esc_attr__('Company name (optional)', 'barab');
    ...
    $fields['billing']['billing_phone']['placeholder'] = esc_attr__('Phone', 'barab');
    ...
    $fields['billing']['billing_email']['placeholder'] = esc_attr__('Email address', 'barab');
    ...
    $fields['billing']['billing_city']['placeholder'] = esc_attr__('Town / City', 'barab');
    ...
    $fields['billing']['billing_postcode']['placeholder'] = esc_attr__('Postcode', 'barab');
    ...
    $fields['shipping']['shipping_first_name']['placeholder'] = esc_attr__('First Name', 'barab');
    ...
    $fields['shipping']['shipping_last_name']['placeholder'] = esc_attr__('Last Name', 'barab');
    ...
    $fields['shipping']['shipping_company']['placeholder'] = esc_attr__('Company name (optional)', 'barab');
    ...
    $fields['shipping']['shipping_phone']['placeholder'] = esc_attr__('Phone', 'barab');
    ...
    $fields['shipping']['shipping_email']['placeholder'] = esc_attr__('Email address', 'barab');
    ...
    $fields['shipping']['shipping_city']['placeholder'] = esc_attr__('Town / City', 'barab');
    ...
    $fields['shipping']['shipping_postcode']['placeholder'] = esc_attr__('Postcode', 'barab');
...
add_filter( 'woocommerce_default_address_fields', 'barab_override_default_locale_fields' );

function barab_override_default_locale_fields( $fields ) {
...
add_filter( 'woocommerce_billing_fields' , 'barab_custom_billing_fields' );

function barab_custom_billing_fields( $fields ) {
    ...
    $fields['billing_first_name']['placeholder'] = esc_attr__('First Name', 'barab');
    ...
    $fields['billing_last_name']['placeholder'] = esc_attr__('Last Name', 'barab');
    ...
    $fields['billing_company']['placeholder'] = esc_attr__('Company name (optional)', 'barab');
    ...
    $fields['billing_phone']['placeholder'] = esc_attr__('Phone', 'barab');
    ...
    $fields['billing_email']['placeholder'] = esc_attr__('Email address', 'barab');
    ...
    $fields['billing_city']['placeholder'] = esc_attr__('Town / City', 'barab');
    ...
    $fields['billing_postcode']['placeholder'] = esc_attr__('Postcode', 'barab');
...
add_filter( 'woocommerce_shipping_fields' , 'barab_custom_shipping_fields' );

function barab_custom_shipping_fields( $fields ) {
    ...
    $fields['shipping_first_name']['placeholder'] = esc_attr__('First Name', 'barab');
    ...
    $fields['shipping_last_name']['placeholder'] = esc_attr__('Last Name', 'barab');
    ...
    $fields['shipping_company']['placeholder'] = esc_attr__('Company name (optional)', 'barab');
    ...
    $fields['shipping_phone']['placeholder'] = esc_attr__('Phone', 'barab');
    ...
    $fields['shipping_email']['placeholder'] = esc_attr__('Email address', 'barab');
    ...
    $fields['shipping_city']['placeholder'] = esc_attr__('Town / City', 'barab');
    ...
    $fields['shipping_postcode']['placeholder'] = esc_attr__('Postcode', 'barab');
...
add_action('woocommerce_before_main_content','barab_shop_col_start_cb');



// Shop column end wrapper hook

add_action('woocommerce_after_main_content','barab_shop_col_end_cb',10);



// shop main content hook

add_action('barab_shop_main_content','barab_shop_main_content_cb',10);



// shop main content end hook

add_action('barab_shop_main_content_end','barab_shop_main_content_end_cb',10);



// barab woocommerce pagination hook

add_action('woocommerce_after_shop_loop','barab_woocommerce_pagination',10);



// barab woocommerce filter wrapper hook

add_action('woocommerce_before_shop_loop','barab_woocommerce_filter_wrapper',20);



// barab woocommerce product content wrapper

add_action('barab_woocommerce_product_content', 'barab_woocommerce_tab_content_wrapper_start', 10 );

add_action('barab_woocommerce_product_content', 'barab_grid_tab_content_cb', 10 );

add_action('barab_woocommerce_product_content', 'barab_list_tab_content_cb', 20 );

add_action('barab_woocommerce_product_content', 'barab_woocommerce_tab_content_wrapper_end', 30 );



// barab woocommerce get sidebar

add_action('woocommerce_sidebar','barab_woocommerce_get_sidebar',10);
...
// barab shop loop product thumbnail hook

add_action( 'woocommerce_before_shop_loop_item', 'barab_loop_product_thumbnail', 10 );



// barab shop loop hozrizontal product thumbnail hook

add_action( 'woocommerce_before_shop_horizontal_loop_item', 'barab_loop_horiontal_product_thumbnail', 10 );



// barab shop loop horizontal product summary hook

add_action('barab_woocommerce_shop_three_loop_product_summary','barab_woocommerce_shop_three_loop_product_summary_cb',10);
...
add_action('woocommerce_before_single_product_summary', 'barab_woocommerce_before_single_product_summary',10);



// single product title

add_action('woocommerce_single_product_summary', 'barab_woocommerce_single_product_title', 30 );



// single product price and rating

add_action('woocommerce_single_product_summary', 'barab_woocommerce_single_product_price_rating', 20 );



// single product excerpt

add_action('woocommerce_single_product_summary', 'barab_woocommerce_single_product_excerpt', 40 );



// single product availability

add_action( 'woocommerce_single_product_summary', 'barab_woocommerce_single_product_availability', 50 );



// single product add to cart button

add_action('woocommerce_single_product_summary','barab_woocommerce_single_add_to_cart_button',60);



// single product meta hook

add_action('woocommerce_single_product_summary','barab_woocommerce_single_meta',80);



// single product sidebar

add_action('barab_woocommerce_single_product_sidebar','barab_woocommerce_single_product_sidebar_cb');
...
add_action('barab_quickview_before_single_product_summary','barab_woocommerce_before_single_product_summary',10);



// single product price and rating

add_action('barab_quickview_single_product_summary','barab_woocommerce_single_product_price_rating',20);



// single product title

add_action('barab_quickview_single_product_summary','barab_woocommerce_quickview_single_product_title',30);



// single product excerpt

add_action('barab_quickview_single_product_summary','barab_woocommerce_single_product_excerpt',40);



// single product add to cart button

add_action('barab_quickview_single_product_summary','barab_woocommerce_single_add_to_cart_button',60);
...
add_action('woocommerce_review_before_comment_meta','barab_woocommerce_reviewer_meta',10,1);
...
add_action('woocommerce_proceed_to_checkout','barab_woocommerce_button_proceed_to_checkout',20);



// cross sell products

add_action('woocommerce_after_cart','barab_woocommerce_cross_sell_display',10);



// mini cart view cart button

add_action('woocommerce_widget_shopping_cart_buttons','barab_minicart_view_cart_button',10);



// mini cart checkout button

add_action('woocommerce_widget_shopping_cart_buttons','barab_minicart_checkout_button',20);
...
// barab woocommerce checkout login form

add_action('woocommerce_before_checkout_form','barab_woocommerce_before_checkout_form',10);
...
add_filter( 'wooscp_button_html', 'barab_wooscp_button_html', 10, 2 );

function barab_wooscp_button_html( $output , $prodid ) {
...
add_filter( 'wooscp_button_text_added', 'barab_woo_compare_btn_text_added', 10, 2 );

function barab_woo_compare_btn_text_added( ){
...
add_filter( 'wooscp_button_text', 'barab_compare_btn_text', 10, 2 );

function barab_compare_btn_text(){
...
add_filter( 'woosq_button_html', 'barab_woosq_button_html', 10, 2 );

function barab_woosq_button_html( $output , $prodid ) {
