<?php
namespace PranaYogaSpace\Kits\Settings\LazyloadWidget;
...
class Preloader extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Preloader', 'prana-yoga' );
	}
	...
	protected function register_toggle_controls() {
		...
		$this->add_control(
			'icon_color',
			array(
				'label' => esc_html__( 'Icon Color', 'prana-yoga' ),
		...
		$this->add_control(
			'icon_animation_type',
			array(
				'label' => __( 'Icon Animation Type', 'prana-yoga' ),
				'label_block' => false,
				'type' => Controls_Manager::SELECT,
				'options' => array(
					'none' => __( 'None', 'prana-yoga' ),
					'lazyLoadWidgetBlink' => __( 'Blink', 'prana-yoga' ),
					'lazyLoadWidgetSpinner' => __( 'Spin', 'prana-yoga' ),
				),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Icon Animation Speed', 'prana-yoga' ) . ' (ms)',
		...
		$this->add_var_group_control( 'overlay', self::VAR_BACKGROUND, array(
			'fields_options' => array(
				'background' => array(
					'label' => esc_html_x( 'Overlay Background Type', 'Background Control', 'prana-yoga' ),
				),
			),
			'separator' => 'before',
		) );
		...
		$this->add_var_group_control( '', self::VAR_BORDER, array(
			'fields_options' => array(
				...
				'color' => array(
					'label' => esc_html__( 'Border Color', 'prana-yoga' ),
					'condition' => array(
						'border!' => array(
							'',
							'none',
