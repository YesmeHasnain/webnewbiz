...
<body id="body" <?php body_class('tp-magic-cursor'); ?>>
	...
	<?php if (!empty($nixer_redux_demo['h9-right-item']) && !empty($nixer_redux_demo['h9-mini-cart-switch'])): ?>
		<?php get_template_part( 'header/header-templates/header', 'minicart' ); ?>
	<?php endif ?>
	<?php get_template_part( 'header/header-templates/header', 'canvas' ); ?>

	<header class="tp-header-inner-ptb tp-header-transparent">
		<div id="header-sticky" class="tp-header-main-sticky p-relative">
			<div class="container container-1760">
				<div class="d-flex justify-content-between align-items-center">
					<div class="tp-header-logo">
						<a href="<?php echo esc_url(home_url('/')); ?>">
							<?php if (!empty($nixer_redux_demo['h9-logo-white']['url'])) { ?>
								<img class="white d-none d-lg-none d-xl-none" data-width="120" src="<?php echo esc_url($nixer_redux_demo['h9-logo-white']['url']); ?>" alt="<?php bloginfo( 'name' ); ?>">
							<?php } else { ?>
							...
							<?php } ?>
							<?php if (!empty($nixer_redux_demo['h9-logo-black']['url'])) { ?>
								<img class="black d-block d-lg-block d-xl-block" data-width="120" src="<?php echo esc_url($nixer_redux_demo['h9-logo-black']['url']); ?>" alt="<?php bloginfo( 'name' ); ?>">
							<?php } else { ?>
					...
					<div class="tp-header-inner-box d-flex align-items-center justify-content-between">
						...
						<?php if (!empty($nixer_redux_demo['h9-right-item'])) { ?>
							<div class="tp-header-inner-right d-flex align-items-center">
								<?php if (!empty($nixer_redux_demo['h9-mini-cart-switch'])): ?>
								...
								<?php endif ?>
								<?php if (!empty($nixer_redux_demo['h9-canvas-switch'])) { ?>
