<?php
namespace PranaYogaSpace\Woocommerce\CmsmastersFramework\Kits\Settings\Woocommerce;
...
class Woocommerce_Pages extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'WooCommerce Pages', 'prana-yoga' );
	}
	...
	protected function register_toggle_controls() {
		$this->add_control(
			...
			array(
				'raw' => esc_html__( 'Select the pages you want to use as your default WooCommerce shop pages', 'prana-yoga' ),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Cart', 'prana-yoga' ),
				'type' => CmsmastersControls::QUERY,
				'select2options' => array(
					'placeholder' => esc_html__( 'Select a page', 'prana-yoga' ),
				),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Checkout', 'prana-yoga' ),
				'type' => CmsmastersControls::QUERY,
				'select2options' => array(
					'placeholder' => esc_html__( 'Select a page', 'prana-yoga' ),
				),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'My Account', 'prana-yoga' ),
				'type' => CmsmastersControls::QUERY,
				'select2options' => array(
					'placeholder' => esc_html__( 'Select a page', 'prana-yoga' ),
				),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Terms & Conditions', 'prana-yoga' ),
				'type' => CmsmastersControls::QUERY,
				'select2options' => array(
					'placeholder' => esc_html__( 'Select a page', 'prana-yoga' ),
				),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Purchase Summary', 'prana-yoga' ),
				'type' => CmsmastersControls::QUERY,
				'select2options' => array(
					'placeholder' => esc_html__( 'Select a page', 'prana-yoga' ),
				),
		...
		$this->add_control(
			...
			array(
				'type' => Controls_Manager::RAW_HTML,
				'raw' => esc_html__( 'Note: Changes you make here will also be reflected in the WooCommerce settings on your WP dashboard', 'prana-yoga' ),
