	...
	class Nova_OP {
		...
		private static function theme_defaults() {
			return [
				...
				'popup_show_again_text' 			=> esc_html__( 'Don’t show this popup again', 'bazien' ),
				...
				'main_menu_font_color'						=> '#272727',
				'main_menu_accent_color'					=> '#F4986D',
				...
				'secondary_font' 						=> array('font-family' => 'Montserrat', 'variant' => '400', 'subsets' => array('latin')),
				...
				'border_color' 								=> '#D9D9D9',
				'site_link_color'							=> '#272727',
				'site_link_hover_color'				=> '#F4986D',
				...
				'sale_page_title'                   	=> esc_html__( 'On Sale!', 'bazien' ),
				'sale_page_badge_text'              	=> esc_html__( 'Sale!', 'bazien' ),
				'new_products_page'                 	=> true,
				'new_products_page_slug'            	=> 'new-products',
				'new_products_page_title'           	=> esc_html__( 'New Products', 'bazien' ),
				'new_products_badge_text'           	=> esc_html__( 'New!', 'bazien' ),
				...
				'footer_text' 							=> esc_html__( '© 2021 Bazien All rights reserved. Designed by Novaworks', 'bazien' ),
				...
				'facebook_link' 						=> '#',
				'twitter_link' 							=> '#',
				'nav_button_title'						=> esc_html__( 'Browse Categories', 'bazien' ),
