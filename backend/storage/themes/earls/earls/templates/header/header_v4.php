...
<div class="boxed_wrapper two">
            ...
            <div class="outer-box">
                ...
                <div class="menu-area">
                    ...
                    <nav class="main-menu navbar-expand-md navbar-light">
                        <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContents">
    ...
    <!-- fixed-page-title -->
    <div class="fixed-page-title home-four">
        <div class="header-lower">
                ...
                <div class="outer-box">
                    ...
                    <div class="menu-area">
                        ...
                        <div class="menu__right__site">
                            <div class="btn-box">
                                <a href="<?php echo esc_url($options->get('btn_link_v4')); ?>" class="theme-btn-two"><?php echo wp_kses($options->get('btn_title_v4'), true); ?></a>
                            </div>
                        </div>
                        <?php } ?>
                        
                        <?php
							if( $options->get('show_social_icon_v4') ):
							$icons = $options->get( 'header_social_icon_v4' );
							if ( ! empty( $icons ) ) :
						?>
                        <div class="media">
                            <ul>
