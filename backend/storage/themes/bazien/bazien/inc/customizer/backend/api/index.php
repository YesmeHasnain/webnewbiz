...
Kirki::add_panel( 'panel_api', array(
    'title'         => esc_html__( 'API keys', 'bazien' ),
    'priority'      => 25,
) );
...
Kirki::add_section( 'mailchimp_api', array(
    'title'          => esc_html__( 'Mailchimp API', 'bazien' ),
    'priority'       => 65,
    'capability'     => 'edit_theme_options',
    'panel'          => 'panel_api'
) );
Kirki::add_section( 'google_api', array(
    'title'          => esc_html__( 'Google API', 'bazien' ),
    'priority'       => 66,
    'capability'     => 'edit_theme_options',
    'panel'          => 'panel_api'
) );
Kirki::add_section( 'instagram_access_token', array(
    'title'          => esc_html__( 'Instagram Access Token', 'bazien' ),
    'priority'       => 67,
    'capability'     => 'edit_theme_options',
    'panel'          => 'panel_api'
) );
...
Kirki::add_field( 'bazien', array(
    ...
    'label'       => esc_html__( 'Instagram Access Token', 'bazien' ),
...
Kirki::add_field( 'bazien', array(
    ...
    'label'       => esc_html__( 'MailChimp API key', 'bazien' ),
    'section'     => $section,
...
Kirki::add_field( 'bazien', array(
    ...
    'label'       => esc_html__( 'MailChimp list ID', 'bazien' ),
    'section'     => $section,
...
Kirki::add_field( 'bazien', array(
    ...
    'label'       => esc_html__( 'Double opt-in', 'bazien' ),
    'section'     => $section,
    'default'     => false,
...
Kirki::add_field( 'bazien', array(
    ...
    'label'       => esc_html__( 'Google maps API key', 'bazien' ),
    'section'     => 'google_api',
    'default'     => '',
    'priority'    => 10,
) );
