	...
	<form class="checkout_coupon woocommerce-form-coupon" method="post" style="display:none" id="woocommerce-checkout-form-coupon">
		<div class="vamtam-checkout-coupon-header">
			<p class="form-row form-row-first">
				...
				<input type="text" name="coupon_code" class="input-text" placeholder="<?php esc_attr_e( 'Coupon code', 'lafeminite' ); ?>" id="coupon_code" value="" />
			</p>
		</div>

		<p class="form-row form-row-last">
			<button type="submit" class="button<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'lafeminite' ); ?>">
				<?php esc_html_e( 'Apply coupon', 'lafeminite' ); ?>
			</button>
		</p>
