		...
		if ( has_post_thumbnail() ) {
			...
			switch( $format ) {
				...
				case 'video':
					...
					get_template_part( 'template-parts/single-post/media/media-style-1', 'video' );

				break;

				case 'gallery':

					get_template_part( 'template-parts/single-post/media/media-style-1', 'gallery' );

				break;

				default:

					get_template_part( 'template-parts/single-post/media/media-style-1', 'standard' );
