	...
	protected function controls_group_quotes( $key = '', $args = array() ) {
			...
			array_merge_recursive(
				...
				array(
					'fields_options' => array(
						'width' => array(
							'label' => esc_html__( 'Border Width', 'prana-yoga' ),
						),
					),
					'exclude' => array( 'color' ),
					'separator' => 'before',
		...
		$this->add_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Cite', 'prana-yoga' ),
					'type' => Controls_Manager::HEADING,
					'separator' => 'before',
				)
			)
		...
		$this->add_control(
			...
			array_merge_recursive(
				...
				array(
					...
					'separator' => 'before',
					'options' => array(
						'none' => esc_html__( 'Hide', 'prana-yoga' ),
						'flex' => esc_html__( 'Show', 'prana-yoga' ),
					),
					'selectors' => array(
		...
		$this->add_responsive_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Horizontal Offset', 'prana-yoga' ),
					'type' => Controls_Manager::SLIDER,
					'size_units' => array(
						'px',
					),
		...
		$this->add_responsive_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Vertical Offset', 'prana-yoga' ),
					'type' => Controls_Manager::SLIDER,
					'size_units' => array(
						'px',
					),
