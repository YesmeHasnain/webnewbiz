<?php
namespace PranaYogaSpace\Woocommerce\CmsmastersFramework;
...
use PranaYogaSpace\Woocommerce\CmsmastersFramework\Kits\Kit as Plugin_Kit;
...
class Plugin {
	...
	public function before_content_import_setup() {
		if ( 'done' === get_option( 'cmsmasters_prana-yoga_remove_woocommerce_pages' ) ) {
			return;
		}
		...
		update_option( 'cmsmasters_prana-yoga_remove_woocommerce_pages', 'done', false );
	}
	...
	public function after_content_import_setup() {
		...
		delete_option( 'cmsmasters_prana-yoga_remove_woocommerce_pages' );
	}
