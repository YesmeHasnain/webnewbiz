	...
	<tr>
		<td class="font-family text-align-left" style="border:0; padding:0;" valign="top" width="50%">
			<?php if ( $email_improvements_enabled ) { ?>
				<b><?php esc_html_e( 'Billing address', 'nixer' ); ?></b>
			<?php } else { ?>
				<h2><?php esc_html_e( 'Billing address', 'nixer' ); ?></h2>
			<?php } ?>

			<address class="address">
				<?php echo wp_kses_post( $address ? $address : esc_html__( 'N/A', 'nixer' ) ); ?>
		...
		<?php if ( ! wc_ship_to_billing_address_only() && $order->needs_shipping_address() && $shipping ) : ?>
			<td class="font-family text-align-left" style="padding:0;" valign="top" width="50%">
				<?php if ( $email_improvements_enabled ) { ?>
					<b><?php esc_html_e( 'Shipping address', 'nixer' ); ?></b>
				<?php } else { ?>
					<h2><?php esc_html_e( 'Shipping address', 'nixer' ); ?></h2>
				<?php } ?>
