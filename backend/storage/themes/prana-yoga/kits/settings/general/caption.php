...
class Caption extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Caption', 'prana-yoga' );
	}
	...
	protected function register_toggle_controls() {
		$this->add_control(
			'notice',
			array(
				'raw' => esc_html__( 'Used in: default caption, Gutenberg editor.', 'prana-yoga' ),
		...
		foreach ( array(
			'outside' => esc_html__( 'Outside', 'prana-yoga' ),
			'inside' => esc_html__( 'Inside', 'prana-yoga' ),
		) as $key => $label ) {
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Image with Caption', 'prana-yoga' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_control(
			'image_notice',
			array(
				'raw' => esc_html__( 'Used for classic wp-caption image.', 'prana-yoga' ),
				'type' => Controls_Manager::RAW_HTML,
