<?php 
    ...
    if($post_meta_data == ''){
        if(!empty($startli_option['course_banner']['url'])):
        $post_meta_data = $startli_option['course_banner']['url'];
        endif;
    }  
    ...
    if(!empty($startli_option['show_banner__course'])):
      $post_meta_data = $startli_option['show_banner__course'];
    endif;
?>
...
<div class="reactheme-breadcrumbs  porfolio-details">
    ...
    <div class="breadcrumbs-single" style="background-image: url('<?php echo esc_url($post_meta_data); ?>')"> 
        ...
        <?php } elseif(!empty($startli_option['course_banner']['url'])){ 
        $course_banner = $startli_option['course_banner']['url'];?>
