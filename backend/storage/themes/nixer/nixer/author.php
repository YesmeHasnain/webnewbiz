				...
				<div class="col-lg-12">
					<div class="tp-blog-heading p-relative pb-70">
						<h3 class="tp-breadcrumb-title tp-title-anim">
							<?php if(isset($nixer_redux_demo['auth-title']) && $nixer_redux_demo['auth-title']!=''){?>
								<?php echo wp_specialchars_decode(esc_attr($nixer_redux_demo['auth-title']));?>
							<?php }else{?>
								<?php echo esc_html__( 'All post by author:', 'nixer' );
							}?>
							<span class="text-cap"><?php printf( esc_html__( ' %s', 'nixer' ), get_the_author() );?></span>
						</h3>
					</div>
				</div>
			</div>
								...
								<div class="postbox__content">
									...
									<div class="postbox__read-more">
										<a href="<?php the_permalink(); ?>" class="tp-btn-border-lg">
											<?php if(isset($nixer_redux_demo['auth-btn-read']) && $nixer_redux_demo['auth-btn-read']!=''){?>
												<?php echo wp_specialchars_decode(esc_attr($nixer_redux_demo['auth-btn-read']));?>
											<?php }else{?>
