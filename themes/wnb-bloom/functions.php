...
function wnb_theme_setup() {
    ...
    register_nav_menus(['header_menu' => __('Header Menu', 'wnb-bloom'), 'footer_menu' => __('Footer Menu', 'wnb-bloom')]);
...
function wnb_theme_scripts() {
    wp_enqueue_style('wnb-fonts', 'https://fonts.googleapis.com/css2?family=Merriweather:wght@300;400;700&family=Source+Sans+3:wght@400;500;600;700&display=swap', [], null);
