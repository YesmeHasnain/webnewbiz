...
<div <?php post_class( 'single-blog-post post-details' ); ?> id="post-<?php the_ID(); ?>">
    <div class="post-content">
        ...
        <?php
            ...
            wp_link_pages( array(
                'before' => '<div class="page-links mt-3"><span class="page-link-label">' . esc_html__( 'Pages:', 'transland' ) . '</span>',
                'after'  => '</div>',
            ) );
        ?>     
    </div>
...
<div class="row tag-share-wrap">
    <div class="col-lg-<?php echo esc_attr(($share_options == '1') ? '8' : '12'); ?> post-tags">
        <h4 class="d-line-block ms-1"><?php echo esc_html__('Tags:', 'transland') ?></h4>
        <?php the_tags( '', '', '' ); ?>
    </div>
