 ...
 * @since 1.0.0
 */
class amedea__morph_perspective extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Morph Perspective', 'amedea' );
	}
	...
	public function get_categories() {
		return [ 'amedea-category' , 'amedea-on-scroll-layout-category' ];
	}
	...
	<section class="content-morph-wrap morph--<?php echo esc_attr($settings['style']); ?>">
		<div id="morph-perspective" class="content-morph">
			<div class="content_morph__img-wrap">
				<div class="content_morph__img content_morph__img--1">
			...
			<p class="content_morph__text content_morph__text--left">
