...
class VamtamElementorBridge {
	...
	public static function add_sticky_header_bg_color_to_elementor_global_settings() {
		...
		$kit->add_repeater_row( 'system_colors', [
			...
			'title' => __( 'Sticky Header Bg Color', 'lafeminite' ),
	...
	*/
		...
		if ( $use_el_global_defaults ) {
			...
			for ( $i = 1; $i <= 8; $i++ ) {
				...
				$kit->add_repeater_row( 'system_colors', [
					...
					'title' => sprintf( __( 'Accent %s', 'lafeminite' ), $i ),
	...
	protected static function add_theme_fonts_to_elementor_global_fonts() {
		...
		if ( $use_el_global_defaults ) {
			...
			// Adding from vamtam_get_option().
			$our_fonts = [
				'primary-font' => __( 'Primary Font', 'lafeminite' ),
				'h1'           => __( 'H1', 'lafeminite' ),
				'h2'           => __( 'H2', 'lafeminite' ),
				'h3'           => __( 'H3', 'lafeminite' ),
				'h4'           => __( 'H4', 'lafeminite' ),
			...
			foreach ( $our_fonts as $font_prefix => $font_title ) {
				...
				$kit->add_repeater_row( 'system_colors', [
					...
					'title' => sprintf( __( '%s', 'lafeminite' ), $font_title ),
	...
	public static function register_locations( $elementor_theme_manager ) {
		...
		$elementor_theme_manager->register_location(
			'page-title-location',
			[
				'label' => esc_html__( 'Page Title', 'lafeminite' ),
				'multiple' => true,
	...
	public static function get_widget_mods_list() {
		...
		*/
		...
		$widget_mods_list = [
			...
			'button'                                => [ 'label' => __( 'Button', 'lafeminite' ) ],
			'form'                                  => [ 'label' => __( 'Form', 'lafeminite' ) ],
			'image'                                 => [ 'label' => __( 'Image', 'lafeminite' ) ],
			'nav-menu'                              => [ 'label' => __( 'Nav Menu', 'lafeminite' ) ],
			'section'                               => [ 'label' => __( 'Section', 'lafeminite' ) ],
			'toggle'                                => [ 'label' => __( 'Toggle', 'lafeminite' ) ],
			'text-editor'                           => [ 'label' => __( 'Text Editor', 'lafeminite' ) ],
			'woocommerce-menu-cart'                 => [ 'label' => __( 'Menu Cart', 'lafeminite' ) ],
			'wc-loops-common-mods'                  => [ 'label' => __( 'WooCommerce Loops (common)', 'lafeminite' ) ],
			'woocommerce-products'                  => [ 'label' => __( 'Products', 'lafeminite' ) ],
			'wc-archive-products'                   => [ 'label' => __( 'Archive Products', 'lafeminite' ) ],
			'woocommerce-product-related'           => [ 'label' => __( 'Product Related', 'lafeminite' ) ],
			'woocommerce-product-upsell'            => [ 'label' => __( 'Upsells', 'lafeminite' ) ],
			'woocommerce-product-data-tabs'         => [ 'label' => __( 'Product Data Tabs', 'lafeminite' ) ],
			'woocommerce-product-meta'              => [ 'label' => __( 'Product Meta', 'lafeminite' ) ],
			'woocommerce-product-images'            => [ 'label' => __( 'Product Images', 'lafeminite' ) ],
			'woocommerce-product-add-to-cart'       => [ 'label' => __( 'Add To Cart', 'lafeminite' ) ],
			'woocommerce-my-account'                => [ 'label' => __( 'WC My Account', 'lafeminite' ) ],
			'archive-posts'                         => [ 'label' => __( 'Archive Posts', 'lafeminite' ) ],
			'posts'                                 => [ 'label' => __( 'Posts', 'lafeminite' ) ],
			'post-comments'                         => [ 'label' => __( 'Post Comments', 'lafeminite' ) ],
			'search-form'                           => [ 'label' => __( 'Search Form', 'lafeminite' ) ],
			// Not a widget, but same logic.
			'vamtam-popup'                          => [ 'label' => __( 'Popup', 'lafeminite' ) ],
			'wp-widget-categories'                  => [ 'label' => __( 'WP Widget Categories', 'lafeminite' ) ],
		];
	...
	public static function get_wc_mods_list() {
		...
		$wc_mods_list = [
			// The order is mirrored in the UI.
			'cart-page-theme-mod'     => [
				'label'       => __( 'Cart', 'lafeminite' ),
				'description' => __( 'Toggles any custom theme styles & funcionality added on the Cart page.', 'lafeminite' ),
			],
			'checkout-page-theme-mod' => [
				'label' => __( 'Checkout', 'lafeminite' ),
				'description' => __( 'Toggles any custom theme styles & funcionality added on the Checkout/Order Received page.', 'lafeminite' ),
			],
			'account-page-theme-mod'  => [
				'label' => __( 'Account', 'lafeminite' ),
				'description' => __( 'Toggles any custom theme styles & funcionality added on the My Account page.', 'lafeminite' ),
			],
		];
	...
	*/
	...
	public static function extract_zip( $file, $to ) {
		...
		if ( ! $unzip_result ) {
			$unzip_result = new \WP_Error( 'error', esc_html__( 'Could not unzip or empty archive.', 'lafeminite' ) );
		}
