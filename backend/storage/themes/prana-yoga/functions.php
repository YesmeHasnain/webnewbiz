...
define( 'CMSMASTERS_THEME_VERSION', '1.3.1' );

// CMSMasters API
define( 'CMSMASTERS_API_ROUTES_URL', 'http://api.cmsmasters.net/wp-json/cmsmasters-api/v1/' );

// Theme options
define( 'CMSMASTERS_THEME_NAME', 'prana-yoga' );
define( 'CMSMASTERS_OPTIONS_PREFIX', 'cmsmasters_prana-yoga_' );
define( 'CMSMASTERS_OPTIONS_NAME', 'cmsmasters_prana-yoga_options' );
