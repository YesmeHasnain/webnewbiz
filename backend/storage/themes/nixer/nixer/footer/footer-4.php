...
?>
			   	<?php 
				$footer_slug = isset($nixer_redux_demo['f4-select']) ? $nixer_redux_demo['f4-select'] : '';
				if ($footer_slug && empty($nixer_redux_demo['f4-widget-switch'])) {
					...
					<section class="tp-footer-6-ptb pt-50" data-bg-color="<?php echo esc_attr($nixer_redux_demo['f4-bg-color']); ?>">
						<div class="container container-1520">
							<div class="tp-footer-6-copyright pb-35">
								<div class="row">
									<div class="col-lg-12 text-center">
										<div class="tp-footer-copyright-text">
											<?php if (!empty($nixer_redux_demo['f4-copyright'])) { ?>
												<p><?php echo html_entity_decode($nixer_redux_demo['f4-copyright']); ?></p>
											<?php } else { ?>
