	...
	protected function controls_group_post_meta( $key = '', $args = array() ) {
		...
		$this->add_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Elements', 'prana-yoga' ),
					'label_block' => true,
					'description' => esc_html__( 'This setting will be applied after save and reload.', 'prana-yoga' ),
					'type' => CmsmastersControls::SELECTIZE,
					'options' => array(
						'categories' => esc_html__( 'Categories', 'prana-yoga' ),
						'author' => esc_html__( 'Author', 'prana-yoga' ),
						'date' => esc_html__( 'Date', 'prana-yoga' ),
						'comments' => esc_html__( 'Comments', 'prana-yoga' ),
						'tags' => esc_html__( 'Tags', 'prana-yoga' ),
					),
					'multiple' => true,
		...
		$color_controls = array(
			'colors_text' => esc_html__( 'Text', 'prana-yoga' ),
			'colors_link' => esc_html__( 'Link', 'prana-yoga' ),
			'colors_hover' => esc_html__( 'Link Hover', 'prana-yoga' ),
		);
			...
			array_merge_recursive(
				...
				array(
					...
					'options' => array(
						...
						'block' => esc_html__( 'Show', 'prana-yoga' ),
					),
					'selectors' => array(
