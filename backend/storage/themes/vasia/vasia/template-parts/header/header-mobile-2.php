<?php
	...
	if($header_layout == '1' || $header_layout == '2') {
		$vertical_menu = true;
	}
	...
	<div class="container">
		<div class="row">
			<div class="col col-5 col-header-mobile">
						...
						<div class="inner">
							...
							<div class="rt-tabs-wrapper">
								<ul class="tabs rt-tabs" id="mobile_menu_tabs_title" role="tablist">
								  <li class="active">
									<a href="#hozmenu"><?php echo esc_html__('Menu', 'vasia'); ?></a>
								  </li>
								  <?php if($vertical_menu): ?>
								  <li class="">
									<a href="#vmenu"><?php echo esc_html__('Categories', 'vasia'); ?></a>
								  </li>
								  <?php endif; ?>
								</ul>
				...
				<?php vasia_the_custom_logo_mobile(); ?>
			</div>
