 ...
 * @since 1.0.0
 */
class amedea__contact_minimal extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Contact Minimal', 'amedea' );
	}
	...
	<section class="contact__container">
		<div class="contact__page">
			<div class="content__inner">
				<div class="contact__minimal">
					<div class="text__inner">
						<p><?php echo esc_html($settings['text_area_1']); ?></p>
						<h2><?php echo sprintf($settings['text_area_2']); ?></h2>
					</div>
		...
		<div class="map__image" style="background-image:url('<?php echo esc_attr($settings['image']['url']); ?>')"></div>
		<?php } ?>
	</section>
