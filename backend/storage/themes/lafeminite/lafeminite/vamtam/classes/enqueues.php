	...
	public static function admin_scripts() {
		...
		wp_localize_script(
			'vamtam-admin', 'VAMTAM_ADMIN', array(
				'addNewIcon' => esc_html__( 'Add New Icon', 'lafeminite' ),
				'iconName'   => esc_html__( 'Icon', 'lafeminite' ),
				'iconText'   => esc_html__( 'Text', 'lafeminite' ),
				'iconLink'   => esc_html__( 'Link', 'lafeminite' ),
				'iconChange' => esc_html__( 'Change', 'lafeminite' ),
				'fonts'      => $GLOBALS['vamtam_fonts'],
				'home_url'   => home_url(),
				'elementsTxt' => esc_html__( 'Enter your Envato Elements Token.', 'lafeminite' ),
				'tfPcTxt' => esc_html__( 'Enter your purchase code from ThemeForest to receive theme updates and support.', 'lafeminite' ),
				'unRegPcTxt' => esc_html__( 'You are about to unregister your purchase code. Are you sure you want to continue?', 'lafeminite' ),
				'unRegTokenTxt' => esc_html__( 'You are about to unregister your Envato Elements Token. Are you sure you want to continue?', 'lafeminite' ),
				'unRegInvalidTokenTxt' => esc_html__( 'There seems to be an issue with your current token registration, likely due to site migration. If you proceed, the theme will be unregistered at your end but the token will remain bound to the URL it was registered at, until you unregister it from there. If you\'d like to re-register this as an Envato Elements purchase, you can always generate a new token. Are you sure you want to continue?', 'lafeminite' ),
		...
		if ( $pagenow === 'update-core.php' ) {
			...
			<script type="text/javascript">
				document.addEventListener( 'DOMContentLoaded', function() {
					...
					if ( ! $valid_pc ) {
						$update_notice  = '<br id="vamtam-notice-br" />' . __( 'Note: Only Envato Market clients with a valid purchase code are entitled to automatic updates. Envato Elements clients must use FTP.', 'lafeminite' );
						$changelog_link = '<span><a href="https://vamtam.com/changelog" target="_blank">' . __('View Changelog', 'lafeminite') . '</a></span>';
